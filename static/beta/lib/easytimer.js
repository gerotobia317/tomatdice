...
!function(t, e) {
    ...
    function s(t, e, n) {
        var r, o = "";
        if ((t = "number" == typeof t ? String(t) : t).length > e)
            return t;
        for (r = 0; r < e; r += 1)
            o += String(n);
    ...
    u.prototype.on = function(t, e) {
        var n = this;
        return Array.isArray(this.events[t]) || (this.events[t] = []),
    ...
    function O() {
        var t, e, o, s, O, T, j, A, E, P, S = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}, D = new i, L = new i, x = new u, V = !1, M = !1, U = {}, k = {
            detail: {
                timer: this
            }
        };
        ...
        function J() {
            var n = b[e];
            Y(W(Date.now())) || (t = setInterval(N, n),
            V = !0,
            M = !1)
        }
        function K() {
        ...
        function $(t) {
            ...
            E = K(),
            Q(),
            "object" === r(t.target) ? T = ot(t.target) : A ? (t.target = {
                seconds: 0
            },
            T = ot(t.target)) : T = null,
            U = {
                precision: e,
                callback: s,
        ...
        function ot(t) {
            if (t) {
                var e = it(T = nt(t));
                return P = E + e.secondTenths * b.secondTenths * o,
                T
            }
        }
        function st(t) {
