...
(function() {
    ...
    function I(h, n, E, w, U) {
        ...
        w.push([h, n, E, U]);
        return h.addEventListener ? (h.addEventListener(n, E, U),
        E) : h.attachEvent ? (w = function(n) {
            n = n || window.event;
    ...
    function hb(h) {
        if (h._menuButton)
            h.exportEnabled ? (V(h._menuButton, {
                backgroundColor: h.toolbar.itemBackgroundColor,
                color: h.toolbar.fontColor
            }),
            La(h._menuButton),
            h._menuButton.title = h._cultureInfo.menuText) : wa(h._menuButton);
        ...
        if (h.exportEnabled && h._dropdownMenu) {
            ...
            for (var E = h._dropdownMenu.childNodes, r = [h._cultureInfo.printText, h._cultureInfo.saveJPGText, h._cultureInfo.savePNGText], U = 0; U < E.length; U++)
                V(E[U], {
                    backgroundColor: h.toolbar.itemBackgroundColor,
                    color: h.toolbar.fontColor
                }),
            ...
            !h._dropdownMenu && (h.exportEnabled && w) && (n = !1,
            ...
            I(h._dropdownMenu, "blur", function() {
                wa(h._dropdownMenu);
    ...
    function ib(h) {
        if (!jb) {
            ...
            h.creditText = ja("B`ow`rKR/bnl")) : (n = h.updateOption("creditText"),
    ...
    function xa(h, n, r) {
        ...
        n.getAttribute("state") !== r && (n.setAttribute("state", r),
        ...
        n.innerHTML = "<img src='" + kb[r].image + "' alt='" + h._cultureInfo[r + "Text"] + "' />",
        V(n.childNodes[0], {
            height: "95%",
            pointerEvents: "none"
        }))
    ...
    function Sa(h, n, r, w, U) {
        ...
        "undefined" !== typeof w && (h = Math.min(w, h),
        "undefined" !== typeof U && (h = Math.max(U, h)));
    ...
    function $(h, n, E, w, U) {
        ...
        h = {};
        this.theme && r(this.parent) && r(n) && r(w) ? h = r(this.predefinedThemes[this.theme]) ? this.predefinedThemes.light1 : this.predefinedThemes[this.theme] : this.parent && (this.parent.themeOptions && this.parent.themeOptions[n]) && (null === w ? h = this.parent.themeOptions[n] : 0 < this.parent.themeOptions[n].length && (w = Math.min(this.parent.themeOptions[n].length - 1, w),
    ...
    var Ha = !1, T = {}, w = !!document.createElement("canvas").getContext, ra = {
        Chart: {
            width: 500,
            height: 400,
            zoomEnabled: !1,
        ...
        en: {}
    }, v = w ? "Trebuchet MS, Helvetica, sans-serif" : "Arial", Fa = w ? "Impact, Charcoal, sans-serif" : "Arial", Aa = {
    ...
    (function() {
        ...
        T._fTWm = function(h) {
            if ("undefined" === typeof T.pro.sCH && !cb)
                try {
                    var n = (new Date).getMonth() % 3, r, w, U = h[T.fSDec("buy")];
    ...
    var gb = function() {
      ...
      , ha = function(h, n, r) {
        ...
        for (var N = 0; B && N < B.length; N++)
            ...
            "." === n && 0 > J)
                ...
                if ("%" === n)
                    ...
                    "E" !== n[0] && "e" !== n[0] || "0" !== n[n.length - 1] || (T = !0);
                0 > J ? (P.push(n),
                "#" === n || "0" === n ? Q++ : "," === n && K++) : (O.push(n),
                "#" !== n && "0" !== n || I++)
            }
        T && (n = Math.floor(h),
        ...
        for (T = B = N = I = J = 0; 0 < P.length; )
            ...
            "#" === n || "0" === n)
                ...
                "E" !== n[0] && "e" !== n[0] || "0" !== n[n.length - 1] || !/[eE][+-]*[0]+/.test(n) ? "," === n ? (N++,
                B = T,
                T = 0,
                0 < A.length && (r = v + r)) : r = 1 < n.length && ('"' === n[0] && '"' === n[n.length - 1] || "'" === n[0] && "'" === n[n.length - 1]) ? n.slice(1, n.length - 1) + r : n + r : (n = 0 > V ? n.replace("+", "").replace("-", "") : n.replace("-", ""),
        ...
        for (P = !1; 0 < O.length; )
            n = O.shift(),
            "#" === n || "0" === n ? 0 < h.length && 0 !== Number(h.join("")) ? (v += h.shift(),
            P = !0) : "0" === n && (v += "0",
            P = !0) : 1 < n.length && ('"' === n[0] && '"' === n[n.length - 1] || "'" === n[0] && "'" === n[n.length - 1]) ? v += n.slice(1, n.length - 1) : "E" !== n[0] && "e" !== n[0] || "0" !== n[n.length - 1] || !/[eE][+-]*[0]+/.test(n) ? v += n : (n = 0 > V ? n.replace("+", "").replace("-", "") : n.replace("-", ""),
      ...
      , Oa = function(h) {
        ...
        r = h.offsetY) : h.layerX || 0 == h.layerX ? (n = h.layerX,
        r = h.layerY) : (n = h.pageX - h.target.offsetLeft,
    ...
    $.prototype.addTo = function(h, n, r, w) {
        ...
        h.splice(r, 0, n),
        w && (this.stockChart || this.chart || this).render()) : window.console && (v.publicProperties && v.publicProperties.hasOwnProperty(h) && "readOnly" === v.publicProperties[h] ? window.console.log('Property "' + h + '" is read-only.') : window.console.log('Property "' + h + "\" doesn't exist. Please check for typo."))
    }
    ;
        ...
        if ("undefined" !== typeof h || this.options._isPlaceholder)
            ...
            this.isOptionsInArray) {
                ...
                var n = this.parent.options[this.optionsName]
                  , r = n.length;
                this.options._isPlaceholder || (Da(n),
                r = n.indexOf(this.options));
                this.options = "undefined" === typeof h ? {} : h;
                n[r] = this.options
            } else
                this.options = "undefined" === typeof h ? {} : h,
                h = this.parent.options,
                this.optionsName ? n = this.optionsName : (n = this._defaultsKey) && 0 !== n.length ? (r = n.charAt(0).toLowerCase(),
    ...
    $.prototype.updateOption = function(h) {
        ...
        var n = ra[this._defaultsKey]
          ...
          , J = this._index;
        this.theme && r(this.parent) && r(B) && r(J) ? w = r(this.predefinedThemes[this.theme]) ? this.predefinedThemes.light1 : this.predefinedThemes[this.theme] : this.parent && (this.parent.themeOptions && this.parent.themeOptions[B]) && (null === J ? w = this.parent.themeOptions[B] : 0 < this.parent.themeOptions[B].length && (w = Math.min(this.parent.themeOptions[B].length - 1, J),
    ...
    $.prototype.addEventListener = function(h, n, r) {
        h && n && (this._eventListeners[h] = this._eventListeners[h] || [],
    ...
    ka.prototype._initialize = function() {
        r(this.padding) || "object" !== typeof this.padding ? this.topPadding = this.rightPadding = this.bottomPadding = this.leftPadding = Number(this.padding) | 0 : (this.topPadding = r(this.padding.top) ? 0 : Number(this.padding.top) | 0,
    ...
    ka.prototype._getLineWithWidth = function(h, n, r) {
        ...
        r > n && 1 < A.length && (A = A.substr(0, A.length - 1),
        r = this.ctx.measureText(A).width);
        n = !0;
    ...
    za.prototype.setLayout = function() {
        if (this.text) {
            var h = this.dockInsidePlotArea ? this.chart.plotArea : this.chart, n = h.layoutManager.getFreeSpace(), w = n.x1, v = n.y1, B = 0, J = 0, A = this.chart._menuButton && this.chart.exportEnabled && "top" === this.verticalAlign ? 22 : 0, K, I;
            "top" === this.verticalAlign || "bottom" === this.verticalAlign ? (null === this.maxWidth && (this.maxWidth = n.width - 4 - A * ("center" === this.horizontalAlign ? 2 : 1)),
            J = 0.5 * n.height - this.margin - 2,
            B = 0) : "center" === this.verticalAlign && ("left" === this.horizontalAlign || "right" === this.horizontalAlign ? (null === this.maxWidth && (this.maxWidth = n.height - 4),
            J = 0.5 * n.width - this.margin - 2) : "center" === this.horizontalAlign && (null === this.maxWidth && (this.maxWidth = n.width - 4),
            J = 0.5 * n.height - 4));
            var P;
            r(this.padding) || "number" !== typeof this.padding ? r(this.padding) || "object" !== typeof this.padding || (P = this.padding.top ? this.padding.top : this.padding.bottom ? this.padding.bottom : 0,
            ...
            P = J.measureText();
            "top" === this.verticalAlign || "bottom" === this.verticalAlign ? ("top" === this.verticalAlign ? (v = n.y1 + 2,
            I = "top") : "bottom" === this.verticalAlign && (v = n.y2 - 2 - P.height,
            I = "bottom"),
            "left" === this.horizontalAlign ? w = n.x1 + 2 : "center" === this.horizontalAlign ? w = n.x1 + n.width / 2 - P.width / 2 : "right" === this.horizontalAlign && (w = n.x2 - 2 - P.width - A),
            K = this.horizontalAlign,
            this.width = P.width,
            this.height = P.height) : "center" === this.verticalAlign && ("left" === this.horizontalAlign ? (w = n.x1 + 2,
            v = n.y2 - 2 - (this.maxWidth / 2 - P.width / 2),
            B = -90,
            I = "left",
            this.width = P.height,
            this.height = P.width) : "right" === this.horizontalAlign ? (w = n.x2 - 2,
            v = n.y1 + 2 + (this.maxWidth / 2 - P.width / 2),
            B = 90,
            I = "right",
            this.width = P.height,
            this.height = P.width) : "center" === this.horizontalAlign && (v = h.y1 + (h.height / 2 - P.height / 2),
    ...
    Ua.prototype.get = function(h, r) {
        var w = null;
        0 < this.pool.length ? (w = this.pool.pop(),
        Ma(w, h, r)) : w = va(h, r);
        return w
    }
    ;
    ...
    var Pa = {
        ...
        formatNumber: function(h, r, w) {
            w = w || "en";
            if (Ka[w])
                return ha(h, r || "#,##0.##", new Ja(w));
            throw "Unknown Culture Name";
        },
        formatDate: function(h, r, w) {
            w = w || "en";
            if (Ka[w])
                return Ba(h, r || "DD MMM YYYY", new Ja(w));
            throw "Unknown Culture Name";
        }
    };
    ...
    v = Pa.Chart = function() {
        ...
        function n(a, d, c) {
            ...
            w ? this.plotArea.ctx = this.ctx : (this.plotArea.canvas = va(a, d),
            ...
            this.windowResizeHandler = I(window, "resize", function() {
            ...
            I(this.overlaidCanvas, "mousemove", function(a) {
                b._mouseEventHandler(a)
            }, this.allDOMEventHandlers),
            I(this.overlaidCanvas, "mouseup", function(a) {
                b._mouseEventHandler(a)
            }, this.allDOMEventHandlers),
            I(this.overlaidCanvas, "mousedown", function(a) {
                b._mouseEventHandler(a);
                wa(b._dropdownMenu)
            }, this.allDOMEventHandlers),
            I(this.overlaidCanvas, "mouseout", function(a) {
                b._mouseEventHandler(a)
            }, this.allDOMEventHandlers),
            I(this.overlaidCanvas, window.navigator.msPointerEnabled ? "MSPointerDown" : "touchstart", function(a) {
                b._touchEventHandler(a)
            }, this.allDOMEventHandlers),
            I(this.overlaidCanvas, window.navigator.msPointerEnabled ? "MSPointerMove" : "touchmove", function(a) {
                b._touchEventHandler(a)
            }, this.allDOMEventHandlers),
            I(this.overlaidCanvas, window.navigator.msPointerEnabled ? "MSPointerUp" : "touchend", function(a) {
                b._touchEventHandler(a)
            }, this.allDOMEventHandlers),
            I(this.overlaidCanvas, window.navigator.msPointerEnabled ? "MSPointerCancel" : "touchcancel", function(a) {
                b._touchEventHandler(a)
            }, this.allDOMEventHandlers),
        ...
        function B(a, d, c, b, e, f, l, s, D, k) {
            ...
            a.beginPath();
            D && 0 < s.thickness ? (a.moveTo(b - l.thickness / 2, Math.round((c + e) / 2) - p),
            a.lineTo(d + l.thickness / 2, Math.round((c + e) / 2) - p)) : 0 < s.thickness && (a.moveTo(Math.round((d + b) / 2) - p, c + l.thickness / 2),
            ...
            a.beginPath();
            D && 0 < l.thickness ? (a.moveTo(b - m, c),
            a.lineTo(b - m, e),
            a.moveTo(d + m, c),
            a.lineTo(d + m, e)) : 0 < l.thickness && (a.moveTo(d, c + m),
            a.lineTo(b, c + m),
            a.moveTo(d, e - m),
            a.lineTo(b, e - m));
            a.stroke();
        ...
        function A(a, d, c, b, e, f) {
            ...
            r(this.chart.sessionVariables.axisX[b]) && (this.chart.sessionVariables.axisX[b] = {}),
            this.sessionVariables = this.chart.sessionVariables.axisX[b]) : (this.optionsName = "axisX2",
            r(this.chart.sessionVariables.axisX2[b]) && (this.chart.sessionVariables.axisX2[b] = {}),
        ...
        function ea(a, d, c, b) {
            ...
            if (this.options.customBreaks && 0 < this.options.customBreaks.length) {
                for (a = 0; a < this.options.customBreaks.length; a++)
                    this.customBreaks.push(new ga(this.chart,"customBreaks",this.options.customBreaks[a],a,++this.chart._eventManager.lastObjectId,this)),
        ...
        n.prototype._updateOptions = function() {
            ...
            if (this.options.zoomEnabled || this.panEnabled) {
                if (this._zoomButton)
                    ...
                    I(this._zoomButton, "click", function() {
                        ...
                        a.panEnabled = !0,
                        xa(a, a._zoomButton, "zoom")) : (a.zoomEnabled = !0,
                        a.panEnabled = !1,
                ...
                I(this._resetButton, "touchstart", function(a) {
                    d = !0
                }, this.allDOMEventHandlers),
            ...
            a._resetButton.getAttribute("state") !== a._cultureInfo.resetText && xa(a, a._resetButton, "reset"));
        ...
        n.prototype._initialize = function() {
            ...
            if (this.options.data) {
                for (var c = 0; c < this.options.data.length; c++)
                    if (a++,
                    !this.options.data[c].type || 0 <= n._supportedChartTypes.indexOf(this.options.data[c].type)) {
                        var b = new W(this,this.options.data[c],a - 1,++this._eventManager.lastObjectId);
                        "error" === b.type && (b.linkedDataSeriesIndex = r(this.options.data[c].linkedDataSeriesIndex) ? c - 1 : this.options.data[c].linkedDataSeriesIndex,
        ...
        n.prototype.setLayout = function() {
            ...
            this._zoomButton.style.borderRight = this.toolbar.buttonBorderThickness + "px solid " + this.toolbar.buttonBorderColor,
            this._resetButton.style.borderRight = (this.exportEnabled ? this.toolbar.buttonBorderThickness : 0) + "px solid " + this.toolbar.buttonBorderColor) : (wa(this._zoomButton, this._resetButton),
            ...
            for (d = 0; d < this._axes.length; d++)
                if (this._axes[d].scaleBreaks && this._axes[d].scaleBreaks._appliedBreaks.length) {
                    w ? (this._breaksCanvas = va(this.width, this.height, !0),
        ...
        n.prototype.renderElements = function() {
            ...
            for (d = 0; d < this.plotInfo.plotTypes.length; d++)
                for (var f = this.plotInfo.plotTypes[d], l = 0; l < f.plotUnits.length; l++) {
                    ...
                    s.targetCanvas = null;
                    this.animatedRender && (s.targetCanvas = va(this.width, this.height),
                    ...
                    this.animatedRender && (s.targetCanvasCtx.miterLimit = e,
                    D && c.push(D))
                }
            ...
            this.animatedRender && 0 < this._indexLabels.length && (e = va(this.width, this.height).getContext("2d"),
            c.push(this.renderIndexLabels(e)));
            var m = this;
            if (0 < c.length)
                m.disableToolTip = !0,
                m._animator.animate(200, m.animationDuration, function(a) {
                    m.ctx.clearRect(0, 0, m.width, m.height);
                    m.ctx.drawImage(b, 0, 0, Math.floor(m.width * la), Math.floor(m.height * la), 0, 0, m.width, m.height);
                    for (var e = 0; e < c.length; e++)
                        D = c[e],
                        1 > a && "undefined" !== typeof D.startTimePercent ? a >= D.startTimePercent && D.animationCallback(D.easingFunction(a - D.startTimePercent, 0, 1, 1 - D.startTimePercent), D) : D.animationCallback(D.easingFunction(a, 0, 1, 1), D);
        ...
        n.prototype._processMultiseriesPlotUnit = function(a) {
            if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
                for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, l = 0; l < a.dataSeriesIndexes.length; l++) {
                    var s = this.data[a.dataSeriesIndexes[l]], D = 0, k = !1, m = !1, p;
                    ...
                    if (s.dataPoints[D].x && s.dataPoints[D].x.getTime || "dateTime" === s.xValueType)
                        f = !0;
                    for (D = 0; D < s.dataPoints.length; D++) {
                        "undefined" === typeof s.dataPoints[D].x && (s.dataPoints[D].x = D + (a.axisX.logarithmic ? 1 : 0));
                        s.dataPoints[D].x.getTime ? (f = !0,
                        b = s.dataPoints[D].x.getTime()) : b = s.dataPoints[D].x;
                        e = s.dataPoints[D].y;
                        b < c.min && (c.min = b);
                        b > c.max && (c.max = b);
                        ...
                        if (0 < D) {
                            ...
                            null !== e && null !== s.dataPoints[D - 1].y && (a.axisY.logarithmic ? (t = e / s.dataPoints[D - 1].y,
                            1 > t && (t = 1 / t),
                            d.minDiff > t && 1 !== t && (d.minDiff = t)) : (t = e - s.dataPoints[D - 1].y,
                            0 > t && (t *= -1),
        ...
        n.prototype._processStackedPlotUnit = function(a) {
            if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
                for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, l = [], s = [], D = Infinity, k = -Infinity, m = 0; m < a.dataSeriesIndexes.length; m++) {
                    var p = this.data[a.dataSeriesIndexes[m]], q = 0, g = !1, t = !1, h;
                    if ("normal" === p.axisPlacement || "xySwapped" === p.axisPlacement)
                        var fa = a.axisX.sessionVariables.newViewportMinimum ? a.axisX.sessionVariables.newViewportMinimum : this.options.axisX && this.options.axisX.viewportMinimum ? this.options.axisX.viewportMinimum : this.options.axisX && this.options.axisX.minimum ? this.options.axisX.minimum : -Infinity
                    ...
                    for (q = 0; q < p.dataPoints.length; q++) {
                        ...
                        if (0 < q) {
                            ...
                            null !== e && null !== p.dataPoints[q - 1].y && (a.axisY.logarithmic ? 0 < e && (y = e / p.dataPoints[q - 1].y,
                            1 > y && (y = 1 / y),
                            d.minDiff > y && 1 !== y && (d.minDiff = y)) : (y = e - p.dataPoints[q - 1].y,
                            0 > y && (y *= -1),
                        ...
                        if (b < fa && !g)
                            ...
                            0 <= e ? l[b] ? l[b] += e : (l[b] = e,
                            D = Math.min(e, D)) : s[b] ? s[b] += e : (s[b] = e,
                            k = Math.max(e, k)))
                        }
                    }
                    ...
                    d.dataPointYNegativeSums.push.apply(d.dataPointYPositiveSums, s)) : (d.dataPointYPositiveSums = l,
                ...
                for (q in l)
                    ...
                    a > d.max && (d.max = a),
                    q < c.viewPortMin || q > c.viewPortMax || (a < d.viewPortMin && (d.viewPortMin = Math.min(a, D)),
                    a > d.viewPortMax && (d.viewPortMax = a)));
                for (q in s)
                    s.hasOwnProperty(q) && !isNaN(q) && (a = s[q],
                    a < d.min && (d.min = a),
        ...
        n.prototype._processStacked100PlotUnit = function(a) {
            if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
                for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, l = !1, s = !1, D = [], k = 0; k < a.dataSeriesIndexes.length; k++) {
                    var m = this.data[a.dataSeriesIndexes[k]], p = 0, q = !1, g = !1, t;
                    if ("normal" === m.axisPlacement || "xySwapped" === m.axisPlacement)
                        var h = a.axisX.sessionVariables.newViewportMinimum ? a.axisX.sessionVariables.newViewportMinimum : this.options.axisX && this.options.axisX.viewportMinimum ? this.options.axisX.viewportMinimum : this.options.axisX && this.options.axisX.minimum ? this.options.axisX.minimum : -Infinity
                          , fa = a.axisX.sessionVariables.newViewportMaximum ? a.axisX.sessionVariables.newViewportMaximum : this.options.axisX && this.options.axisX.viewportMaximum ? this.options.axisX.viewportMaximum : this.options.axisX && this.options.axisX.maximum ? this.options.axisX.maximum : Infinity;
                    ...
                    for (p = 0; p < m.dataPoints.length; p++) {
                        ...
                        m.dataPoints[p].x.getTime ? (f = !0,
                        b = m.dataPoints[p].x.getTime()) : b = m.dataPoints[p].x;
                        ...
                        if (0 < p) {
                            ...
                            r(e) || null === m.dataPoints[p - 1].y || (a.axisY.logarithmic ? 0 < e && (u = e / m.dataPoints[p - 1].y,
                            1 > u && (u = 1 / u),
                            d.minDiff > u && 1 !== u && (d.minDiff = u)) : (u = e - m.dataPoints[p - 1].y,
                            0 > u && (u *= -1),
                        ...
                        if (b < h && !q)
                            ...
                            b < c.viewPortMin && (c.viewPortMin = b);
                            b > c.viewPortMax && (c.viewPortMax = b);
                            null === e ? c.viewPortMin === b && t < b && (c.viewPortMin = t) : (a.yTotals[b] = (a.yTotals[b] ? a.yTotals[b] : 0) + e,
                            a.yAbsTotals[b] = (a.yAbsTotals[b] ? a.yAbsTotals[b] : 0) + Math.abs(e),
                            0 <= e ? l = !0 : 0 > e && (s = !0),
                ...
                a.axisY.logarithmic ? (d.max = r(d.viewPortMax) ? 99 * Math.pow(a.axisY.logarithmBase, -0.05) : Math.max(d.viewPortMax, 99 * Math.pow(a.axisY.logarithmBase, -0.05)),
                d.min = r(d.viewPortMin) ? 1 : Math.min(d.viewPortMin, 1)) : l && !s ? (d.max = r(d.viewPortMax) ? 99 : Math.max(d.viewPortMax, 99),
                d.min = r(d.viewPortMin) ? 1 : Math.min(d.viewPortMin, 1)) : l && s ? (d.max = r(d.viewPortMax) ? 99 : Math.max(d.viewPortMax, 99),
                d.min = r(d.viewPortMin) ? -99 : Math.min(d.viewPortMin, -99)) : !l && s && (d.max = r(d.viewPortMax) ? -1 : Math.max(d.viewPortMax, -1),
        ...
        n.prototype._processMultiYPlotUnit = function(a) {
            if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
                for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f, l, s = !1, D = 0; D < a.dataSeriesIndexes.length; D++) {
                    var k = this.data[a.dataSeriesIndexes[D]], m = 0, p = !1, q = !1, g, t, h;
                    ...
                    for (m = 0; m < k.dataPoints.length; m++) {
                        ...
                        k.dataPoints[m].x.getTime ? (s = !0,
                        b = k.dataPoints[m].x.getTime()) : b = k.dataPoints[m].x;
                        ...
                        f < d.min && (d.min = f);
                        l > d.max && (d.max = l);
                        0 < m && (a.axisX.logarithmic ? (t = b / k.dataPoints[m - 1].x,
                        1 > t && (t = 1 / t),
                        c.minDiff > t && 1 !== t && (c.minDiff = t)) : (t = b - k.dataPoints[m - 1].x,
                        0 > t && (t *= -1),
                        c.minDiff > t && 0 !== t && (c.minDiff = t)),
                        e && (null !== e[0] && k.dataPoints[m - 1].y && null !== k.dataPoints[m - 1].y[0]) && (a.axisY.logarithmic ? (t = e[0] / k.dataPoints[m - 1].y[0],
                        1 > t && (t = 1 / t),
                        d.minDiff > t && 1 !== t && (d.minDiff = t)) : (t = e[0] - k.dataPoints[m - 1].y[0],
                        0 > t && (t *= -1),
                        d.minDiff > t && 0 !== t && (d.minDiff = t))));
                        if (!(b < r) || p) {
                            if (!p && (p = !0,
            ...
            if ("waterfall" === a.type && a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
                for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, l = 0; l < a.dataSeriesIndexes.length; l++) {
                    ...
                    if (s.dataPoints[D].x && s.dataPoints[D].x.getTime || "dateTime" === s.xValueType)
                        f = !0;
                    for (D = 0; D < s.dataPoints.length; D++)
                        "undefined" !== typeof s.dataPoints[D].isCumulativeSum && !0 === s.dataPoints[D].isCumulativeSum ? (s.dataPointEOs[D].cumulativeSumYStartValue = 0,
                        s.dataPointEOs[D].cumulativeSum = 0 === D ? 0 : s.dataPointEOs[D - 1].cumulativeSum,
                        s.dataPoints[D].y = 0 === D ? 0 : s.dataPointEOs[D - 1].cumulativeSum) : "undefined" !== typeof s.dataPoints[D].isIntermediateSum && !0 === s.dataPoints[D].isIntermediateSum ? (s.dataPointEOs[D].cumulativeSumYStartValue = p,
                        s.dataPointEOs[D].cumulativeSum = 0 === D ? 0 : s.dataPointEOs[D - 1].cumulativeSum,
                        s.dataPoints[D].y = 0 === D ? 0 : b,
                        p = 0 === D ? 0 : s.dataPointEOs[D - 1].cumulativeSum,
                        b = 0) : (e = "number" !== typeof s.dataPoints[D].y ? 0 : s.dataPoints[D].y,
                        s.dataPointEOs[D].cumulativeSumYStartValue = 0 === D ? 0 : s.dataPointEOs[D - 1].cumulativeSum,
                        s.dataPointEOs[D].cumulativeSum = 0 === D ? e : s.dataPointEOs[D - 1].cumulativeSum + e,
                        b += e);
                    for (D = 0; D < s.dataPoints.length; D++)
                        if ("undefined" === typeof s.dataPoints[D].x && (s.dataPoints[D].x = D + (a.axisX.logarithmic ? 1 : 0)),
                        s.dataPoints[D].x.getTime ? (f = !0,
                        b = s.dataPoints[D].x.getTime()) : b = s.dataPoints[D].x,
                        e = s.dataPoints[D].y,
                        b < c.min && (c.min = b),
                        b > c.max && (c.max = b),
                        s.dataPointEOs[D].cumulativeSum < d.min && (d.min = s.dataPointEOs[D].cumulativeSum),
                        s.dataPointEOs[D].cumulativeSum > d.max && (d.max = s.dataPointEOs[D].cumulativeSum),
                        0 < D && (a.axisX.logarithmic ? (p = b / s.dataPoints[D - 1].x,
                        1 > p && (p = 1 / p),
                        c.minDiff > p && 1 !== p && (c.minDiff = p)) : (p = b - s.dataPoints[D - 1].x,
                        0 > p && (p *= -1),
                        c.minDiff > p && 0 !== p && (c.minDiff = p)),
                        null !== e && null !== s.dataPoints[D - 1].y && (a.axisY.logarithmic ? (e = s.dataPointEOs[D].cumulativeSum / s.dataPointEOs[D - 1].cumulativeSum,
                        1 > e && (e = 1 / e),
                        d.minDiff > e && 1 !== e && (d.minDiff = e)) : (e = s.dataPointEOs[D].cumulativeSum - s.dataPointEOs[D - 1].cumulativeSum,
                        0 > e && (e *= -1),
                        ...
                        !(b < q) || k) {
                            ...
                            b < c.viewPortMin && (c.viewPortMin = b);
                            b > c.viewPortMax && (c.viewPortMax = b);
                            0 < D && (s.dataPointEOs[D - 1].cumulativeSum < d.viewPortMin && (d.viewPortMin = s.dataPointEOs[D - 1].cumulativeSum),
                            s.dataPointEOs[D - 1].cumulativeSum > d.viewPortMax && (d.viewPortMax = s.dataPointEOs[D - 1].cumulativeSum));
        ...
        n.prototype.calculateAutoBreaks = function() {
                        ...
                        for (var d = a.axisY.dataInfo, f = a.axisX.dataInfo, g, l = f.min, k = f.max, m = d.min, p = d.max, f = f._dataRanges, d = d._dataRanges, q, s = 0, D = 0; D < a.dataSeriesIndexes.length; D++) {
                            ...
                            if (!(4 > h.dataPoints.length))
                                for (s = 0; s < h.dataPoints.length; s++)
                                    if (b && (q = (k + 1 - l) * Math.max(parseFloat(a.axisX.scaleBreaks.collapsibleThreshold) || 10, 10) / 100,
                    ...
                    for (var b = a.axisX.dataInfo, c = b.min, d = b.max, f = b._dataRanges, g, l = 0, k = 0; k < a.dataSeriesIndexes.length; k++) {
                        ...
                        if (!(4 > m.dataPoints.length))
                            for (l = 0; l < m.dataPoints.length; l++)
                                ...
                                b = m.dataPoints[l].x.getTime ? m.dataPoints[l].x.getTime() : m.dataPoints[l].x,
                                g = Math.floor((b - c) / g),
                                b < f[g].min && (f[g].min = b),
                                b > f[g].max && (f[g].max = b)
                    }
            ...
            if (f) {
                for (l = 0; l < this.plotInfo.plotTypes.length; l++)
                    for (f = this.plotInfo.plotTypes[l],
                    s = 0; s < f.plotUnits.length; s++)
                        b = f.plotUnits[s],
                ...
                for (l = 0; l < this._axes.length; l++)
                    if (this._axes[l].dataInfo._dataRanges) {
                        ...
                        if (this._axes[l].dataInfo.dataPointYPositiveSums) {
                            ...
                            m = k;
                            for (s in q)
                                if (q.hasOwnProperty(s) && !isNaN(s) && (p = q[s],
                                !r(p))) {
                        ...
                        if (this._axes[l].dataInfo.dataPointYNegativeSums) {
                            ...
                            m = k;
                            for (s in q)
                                q.hasOwnProperty(s) && !isNaN(s) && (p = -1 * q[s],
                                r(p) || (g = Math.floor((p - D) / b),
                                p < m[g].min && (m[g].min = p),
                                p > m[g].max && (m[g].max = p)));
                        ...
                        for (s = 0; s < Math.min(f.length, this._axes[l].scaleBreaks.maxNumberOfAutoBreaks); s++)
                            ...
                            this._axes[l].scaleBreaks.autoBreaks.push(new ga(this,"autoBreaks",b,s,++this._eventManager.lastObjectId,this._axes[l].scaleBreaks)),
        ...
        n.prototype.getObjectAtXY = function(a, d, c) {
            ...
            if (c = this.getDataPointAtXY(a, d, c || !1))
                ...
                b = Za(a, d, this._eventManager.ghostCtx);
            else
        ...
        n.prototype._mouseEventHandler = function(a) {
            ...
            n.capturedEventParam && (b = n.capturedEventParam,
            ...
            if (this.interactivityEnabled)
                ...
                Ha && window.console && (window.console.log(c + " --\x3e x: " + d.x + "; y:" + d.y),
                        ...
                        for (var f = 0; f < this._events.length; f++)
                            if (this._events[f].hasOwnProperty(c))
                                ...
                                d.x >= e.x1 && d.x <= e.x2 && d.y >= e.y1 && d.y <= e.y2) {
                                    ...
                                    "mousedown" === c && !0 === b.capture ? (n.capturedEventParam = b,
                ...
                if (this.panEnabled || this.zoomEnabled) {
                    if (this.panEnabled)
                        for (e = f = 0; e < this._axes.length; e++)
                            ...
                            l = !0) : c.viewportMaximum > c.maximum && (f = c.viewportMaximum / c.maximum,
                            c.sessionVariables.newViewportMinimum = c.viewportMinimum / f,
                            c.sessionVariables.newViewportMaximum = c.viewportMaximum / f,
                            l = !0) : c.viewportMinimum < c.minimum ? (f = c.minimum - c.viewportMinimum,
                            c.sessionVariables.newViewportMinimum = c.viewportMinimum + f,
                            c.sessionVariables.newViewportMaximum = c.viewportMaximum + f,
                            l = !0) : c.viewportMaximum > c.maximum && (f = c.viewportMaximum - c.maximum,
                            c.sessionVariables.newViewportMinimum = c.viewportMinimum - f,
                    ...
                    l && (this.zoomEnabled && "none" === this._zoomButton.style.display) && (La(this._zoomButton, this._resetButton),
                    xa(this, this._zoomButton, "pan"),
                    xa(this, this._resetButton, "reset")))
                }
            }
            ...
            if (this.isDrag && "none" !== this.plotInfo.axisPlacement) {
                ...
                if (2 < Math.abs(c) && 8 > Math.abs(c) && (this.panEnabled || this.zoomEnabled)) {
                    ...
                    for (var s = 0; s < this.axisX.length; s++)
                        this.axisX[s].crosshair && this.axisX[s].crosshair.enabled && (this.axisX[s].crosshair.hide(),
                        this.axisX[s].crosshair.dispatchEvent("hidden", {
                            chart: this,
                            axis: this.axisX[s].options
                        }, this.axisX[s].crosshair));
                    for (s = 0; s < this.axisX2.length; s++)
                        this.axisX2[s].crosshair && this.axisX2[s].crosshair.enabled && (this.axisX2[s].crosshair.hide(),
                        this.axisX2[s].crosshair.dispatchEvent("hidden", {
                            chart: this,
                            axis: this.axisX2[s].options
                        }, this.axisX2[s].crosshair));
                    for (s = 0; s < this.axisY.length; s++)
                        this.axisY[s].crosshair && this.axisY[s].crosshair.enabled && (this.axisY[s].crosshair.hide(),
                        this.axisY[s].crosshair.dispatchEvent("hidden", {
                            chart: this,
                            axis: this.axisY[s].options
                        }, this.axisY[s].crosshair));
                    for (s = 0; s < this.axisY2.length; s++)
                        this.axisY2[s].crosshair && this.axisY2[s].crosshair.enabled && (this.axisY2[s].crosshair.hide(),
                        this.axisY2[s].crosshair.dispatchEvent("hidden", {
                            chart: this,
                    ...
                    if (this.panEnabled)
                        ...
                        l._panTimerId = setTimeout(function(b, c, e, f) {
                            return function() {
                                ...
                                l.stockChart && (l.stockChart.navigator && l.stockChart.navigator.enabled) && (l.stockChart._rangeEventParameter.type = "rangeChanged",
                        ...
                        this.validateRegion(b, s, e ? a : this.plotArea.x2 - this.plotArea.x1, f ? d : this.plotArea.y2 - this.plotArea.y1, "xy" !== this.zoomType).isValid && (this.resetOverlayedCanvas(),
        ...
        n.prototype.validateRegion = function(a, d, c, b, e) {
            e = e || !1;
            for (var f = 0 <= this.zoomType.indexOf("x"), l = 0 <= this.zoomType.indexOf("y"), s = !1, D = [], k = [], m = [], p = 0; p < this._axes.length; p++)
            ...
            for (l = 0; l < k.length; l++) {
                ...
                if (isFinite(p.dataInfo.minDiff))
                    if (t = p.getApparentDifference(q, g, null, !0),
                    !(f || !(this.panEnabled && p.scaleBreaks && p.scaleBreaks._appliedBreaks.length) && (p.logarithmic && t < Math.pow(p.dataInfo.minDiff, 3) || !p.logarithmic && t < 3 * Math.abs(p.dataInfo.minDiff)) || q < p.minimum || g > p.maximum))
                        D.push(p),
                        m.push({
                            val1: q,
                            val2: g
        ...
        n.prototype.renderIndexLabels = function(a) {
            ...
            for (a = 0; a < this._indexLabels.length; a++) {
                ...
                if (null !== G && "" !== G) {
                    ...
                    if ("normal" === this.plotInfo.axisPlacement) {
                        ...
                        "inside" !== x ? (e = c.y1,
                        f = c.y2,
                        0 < v ? (g = m.point.y + ("horizontal" === z ? t / 2 : 0) - k - s - b,
                        g < e && (g = "auto" === x ? Math.max(m.point.y, e) + t / 2 + s : e + t / 2 + s,
                        A = g + k > m.point.y)) : (g = m.point.y + t / 2 + s + b,
                        g > f - k && (g = "auto" === x ? Math.min(m.point.y, f) + t / 2 - k - s : f + t / 2 - k,
                        A = g < m.point.y))) : (e = Math.max(m.bounds.y1, c.y1),
                        f = Math.min(m.bounds.y2, c.y2 - k + t / 2),
                        b = 0 <= p.indexOf("range") || "error" === p ? 0 < v ? Math.max(m.bounds.y1, c.y1) + t / 2 + s : Math.min(m.bounds.y2, c.y2) + t / 2 - k + s : (Math.max(m.bounds.y1, c.y1) + Math.min(m.bounds.y2, c.y2)) / 2 - k / 2 + t / 2 + ("horizontal" === z ? s : 0),
                        0 < v ? (g = Math.max(m.point.y, b),
                        g < e && ("bubble" === p || "scatter" === p) && (g = Math.max(m.point.y - k - s, c.y1 + s))) : (g = Math.min(m.point.y, b),
                        g > f - k - s && ("bubble" === p || "scatter" === p) && (g = Math.min(m.point.y + s, c.y2 - k - s))),
                        g = Math.min(g, f))
                    } else
                        0 <= p.indexOf("line") || 0 <= p.indexOf("area") || 0 <= p.indexOf("scatter") ? (x = "auto",
                        l = 4) : 0 <= p.indexOf("stacked") ? "auto" === x && (x = "inside") : "bubble" === p && (x = "inside"),
                        g = m.point.y + t / 2 - k / 2 + s,
                        "inside" !== x ? (e = c.x1,
                        f = c.x2,
                        0 > v ? (q = m.point.x - ("horizontal" === z ? D : D - t / 2) - l - b,
                        q < e && (q = "auto" === x ? Math.max(m.point.x, e) + l : e + l,
                        A = q + D > m.point.x)) : (q = m.point.x + ("horizontal" === z ? 0 : t / 2) + l + b,
                        q > f - D - l - b && (q = "auto" === x ? Math.min(m.point.x, f) - ("horizontal" === z ? D : D / 2) - l : f - D - l,
                        A = q < m.point.x))) : (e = Math.max(m.bounds.x1, c.x1),
                        Math.min(m.bounds.x2, c.x2),
                        b = 0 <= p.indexOf("range") || "error" === p ? 0 > v ? Math.max(m.bounds.x1, c.x1) + t / 2 + l : Math.min(m.bounds.x2, c.x2) - D / 2 - l + ("horizontal" === z ? 0 : t / 2) : (Math.max(m.bounds.x1, c.x1) + Math.min(m.bounds.x2, c.x2)) / 2 + ("horizontal" === z ? 0 : t / 2),
                        q = 0 > v ? Math.max(m.point.x, b) - ("horizontal" === z ? D / 2 : 0) : Math.min(m.point.x, b) - D / 2,
                        q = Math.max(q, e));
                    "vertical" === z && (g += k - t / 2);
                    h.x = q;
                    h.y = g;
                    h.render(!0);
                    n && ("inside" !== x && (0 > p.indexOf("bar") && ("error" !== p || !m.axisSwapped) && m.point.x > c.x1 && m.point.x < c.x2 || !A) && (0 > p.indexOf("column") && ("error" !== p || m.axisSwapped) && m.point.y > c.y1 && m.point.y < c.y2 || !A)) && (d.lineWidth = n,
                    d.strokeStyle = u ? u : "gray",
                    d.setLineDash && d.setLineDash(J(fa, n)),
                    d.beginPath(),
                    d.moveTo(m.point.x, m.point.y),
                    0 <= p.indexOf("bar") || "error" === p && m.axisSwapped ? d.lineTo(q + (0 < m.direction ? -l : D + l) + ("vertical" === z ? -t / 2 : 0), g + ("vertical" === z ? -k / 2 : k / 2 - t / 2) - s) : 0 <= p.indexOf("column") || "error" === p && !m.axisSwapped ? d.lineTo(q + D / 2 - ("horizontal" === z ? 0 : t / 2), g + ("vertical" === z ? (g - k < m.point.y ? 0 : -k) + s : (g - t / 2 < m.point.y ? k : 0) - t / 2)) : d.lineTo(q + D / 2 - ("horizontal" === z ? 0 : t / 2), g + ("vertical" === z ? g - k < m.point.y ? 0 : -k : (g - t / 2 < m.point.y ? k : 0) - t / 2)),
                    d.stroke())
                }
            }
            d = {
            ...
            for (a = 0; a < this._indexLabels.length; a++)
                ...
                m.dataSeries.indexLabelBackgroundColor = r(h) ? w ? "transparent" : null : h;
            return d
        }
        ;
                ...
                for (var f = [], l, s = 0; s < a.dataSeriesIndexes.length; s++) {
                    ...
                    if (0 < m.length) {
                        for (var z = !1, u = 0; u < m.length; u++)
                            if (n = m[u].x.getTime ? m[u].x.getTime() : m[u].x,
                            !(n < a.axisX.dataInfo.viewPortMin || n > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !z)))
                                if ("number" !== typeof m[u].y)
                                    0 < u && !(k.connectNullData || z || r) && (c.stroke(),
                                    w && b.stroke()),
                                    z = !0;
                                else {
                                    ...
                                    r || z ? (!r && k.connectNullData ? (c.setLineDash && (k.options.nullDataLineDashType || p === k.lineDashType && k.lineDashType !== k.nullDataLineDashType) && (c.stroke(),
                                    c.beginPath(),
                                    c.moveTo(l.x, l.y),
                                    p = k.nullDataLineDashType,
                                    c.setLineDash(q)),
                                    c.lineTo(n, x),
                                    w && b.lineTo(n, x)) : (c.beginPath(),
                                    c.moveTo(n, x),
                                    w && (b.beginPath(),
                                    b.moveTo(n, x))),
                                    z = r = !1) : (c.lineTo(n, x),
                                    ...
                                    u < m.length - 1 && (h !== (m[u].lineColor || t) || p !== (m[u].lineDashType || k.lineDashType)) && (c.stroke(),
                                    c.beginPath(),
                                    c.moveTo(n, x),
                                    h = m[u].lineColor || t,
                                    c.strokeStyle = h,
                                    c.setLineDash && (m[u].lineDashType ? (p = m[u].lineDashType,
                                    c.setLineDash(J(p, k.lineThickness))) : (p = k.lineDashType,
                                    c.setLineDash(g))));
        ...
        n.prototype.renderStepLine = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var f = [], l, s = 0; s < a.dataSeriesIndexes.length; s++) {
                    ...
                    if (0 < m.length) {
                        for (var z = !1, u = 0; u < m.length; u++)
                            if (n = m[u].getTime ? m[u].x.getTime() : m[u].x,
                            !(n < a.axisX.dataInfo.viewPortMin || n > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !z)))
                                if ("number" !== typeof m[u].y)
                                    0 < u && !(k.connectNullData || z || r) && (c.stroke(),
                                    w && b.stroke()),
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var l = [], s = 0; s < a.dataSeriesIndexes.length; s++) {
                    ...
                    if (0 < m.length)
                        for (n = !1,
                        r = 0; r < m.length; r++)
                            if (u = m[r].getTime ? m[r].x.getTime() : m[r].x,
                            !(u < a.axisX.dataInfo.viewPortMin || u > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !n)))
                                if ("number" !== typeof m[r].y)
                                    0 < r && !n && (k.connectNullData ? b.setLineDash && (0 < x.length && (k.options.nullDataLineDashType || !m[r - 1].lineDashType)) && (x[x.length - 1].newLineDashArray = q,
                                    p = k.nullDataLineDashType) : (d(x),
                                    x = [])),
                                    n = !0;
                                else {
                                    ...
                                    r < m.length - 1 && (h !== (m[r].lineColor || t) || p !== (m[r].lineDashType || k.lineDashType)) && (h = m[r].lineColor || t,
                                    x[x.length - 1].newStrokeStyle = h,
                                    b.setLineDash && (m[r].lineDashType ? (p = m[r].lineDashType,
                                    x[x.length - 1].newLineDashArray = J(p, k.lineThickness)) : (p = k.lineDashType,
                ...
                for (m = 0; m < a.dataSeriesIndexes.length; m++) {
                    ...
                    if (0 < t.length)
                        for (var h = 5 < p && g.bevelEnabled ? !0 : !1, f = 0; f < t.length; f++)
                            if (t[f].getTime ? D = t[f].x.getTime() : D = t[f].x,
                            !(D < a.axisX.dataInfo.viewPortMin || D > a.axisX.dataInfo.viewPortMax) && "number" === typeof t[f].y) {
                                ...
                                da(c, a.axisX.reversed ? r : l, s, a.axisX.reversed ? l : r, u, b, 0, null, h && (a.axisY.reversed ? 0 > t[f].y : 0 <= t[f].y), (a.axisY.reversed ? 0 <= t[f].y : 0 > t[f].y) && h, !1, !1, g.fillOpacity);
                                b = g.dataPointIds[f];
                        ...
                        for (k = 0; k < u.length; k++)
                            ...
                            !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof u[k].y) {
                                ...
                                if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < u[k].y)
                                    s[b] = u[k].y + (s[b] ? s[b] : 0),
                                    0 < s[b] && (p = a.axisY.convertValueToPixel(s[b]),
                        ...
                        for (var n = 5 < t && r.bevelEnabled ? !0 : !1, k = 0; k < u.length; k++)
                            ...
                            !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof u[k].y) {
                                ...
                                0 <= u[k].y) {
                                    ...
                                    z = p + G,
                                    p = q + G,
                                    a.dataSeriesIndexes.length - 1 === g && 1 >= Math.abs(e.y2 - z) && (z = e.y2),
                                    l[b] = G + (z - p);
                                b = u[k].color ? u[k].color : r._colorSet[k % r._colorSet.length];
                                da(c, m, a.axisY.reversed ? z : p, x, a.axisY.reversed ? p : z, b, 0, null, n && (a.axisY.reversed ? 0 > u[k].y : 0 <= u[k].y), (a.axisY.reversed ? 0 <= u[k].y : 0 > u[k].y) && n, !1, !1, r.fillOpacity);
                                b = r.dataPointIds[k];
                    ...
                    if (0 < u.length) {
                        ...
                        for (k = 0; k < u.length; k++)
                            ...
                            !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof u[k].y) {
                                ...
                                else if (m = a.axisY.convertValueToPixel(u[k].y),
                                0 <= u[k].y) {
                                    var G = f[b] ? f[b] : 0;
                                    z = q + G;
                                    m += G;
                    ...
                    if (0 < u.length) {
                        ...
                        for (k = 0; k < u.length; k++)
                            ...
                            !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof u[k].y) {
                                ...
                                else if (m = a.axisY.convertValueToPixel(x),
                                0 <= u[k].y) {
                                    var G = f[b] ? f[b] : 0;
                                    x = q + G;
                                    m += G;
                                    ...
                                    x = m - G,
                                    m = q - G,
                                    a.dataSeriesIndexes.length - 1 === g && 1 >= Math.abs(e.x1 - x) && (x = e.x1),
                                    l[b] = G + (m - x);
                                b = u[k].color ? u[k].color : r._colorSet[k % r._colorSet.length];
        ...
        n.prototype.renderArea = function(a) {
            var d, c;
            function b() {
                G && (0 < g.lineThickness && f.stroke(),
                a.axisY.logarithmic || 0 >= a.axisY.viewportMinimum && 0 <= a.axisY.viewportMaximum ? z = x : 0 > a.axisY.viewportMaximum ? z = s.y1 : 0 < a.axisY.viewportMinimum && (z = x),
                f.lineTo(r, z),
                f.lineTo(G.x, z),
                f.closePath(),
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var l = this._eventManager.ghostCtx, s = a.axisY.lineCoordinates, D = [], k = this.plotArea, m;
                f.save();
                w && l.save();
                f.beginPath();
                ...
                f.clip();
                w && (l.beginPath(),
                l.rect(k.x1, k.y1, k.width, k.height),
                l.clip());
                for (var p = 0; p < a.dataSeriesIndexes.length; p++) {
                    ...
                    if (0 < t.length) {
                        ...
                        for (var ca = !0; h < t.length; h++)
                            if (n = t[h].x.getTime ? t[h].x.getTime() : t[h].x,
                            !(n < a.axisX.dataInfo.viewPortMin || n > a.axisX.dataInfo.viewPortMax && (!g.connectNullData || !ca)))
                                if ("number" !== typeof t[h].y)
                                    g.connectNullData || (ca || d) || b(),
                                    ca = !0;
                                else {
                                    r = a.axisX.convertValueToPixel(n);
                                    u = a.axisY.convertValueToPixel(t[h].y);
                                    d || ca ? (!d && g.connectNullData ? (f.setLineDash && (g.options.nullDataLineDashType || c === g.lineDashType && g.lineDashType !== g.nullDataLineDashType) && (d = r,
                                    c = u,
                                    r = m.x,
                                    u = m.y,
                                    b(),
                                    ...
                                    h < t.length - 1 && (A !== (t[h].lineColor || v) || c !== (t[h].lineDashType || g.lineDashType)) && (b(),
                                    A = t[h].lineColor || v,
                                    f.strokeStyle = A,
                                    f.setLineDash && (t[h].lineDashType ? (c = t[h].lineDashType,
                                    f.setLineDash(J(c, g.lineThickness))) : (c = g.lineDashType,
                                    f.setLineDash(S))));
                                    ...
                                    0 !== t[h].markerSize && (0 < t[h].markerSize || 0 < g.markerSize) && (n = g.getMarkerProperties(h, r, u, f),
                                    D.push(n),
                                    Z = Q(Z),
                                    w && D.push({
                                        x: r,
        ...
        n.prototype.renderSplineArea = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var h = 0; h < a.dataSeriesIndexes.length; h++) {
                    ...
                    l = Q(l);
                    e.fillStyle = l;
                    var l = [], q = 0, g, t, r = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), n, u = null, y = [];
                    if (0 < p.length) {
                        ...
                        for (t = !1; q < p.length; q++)
                            ...
                            !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax && (!m.connectNullData || !t)))
                                if ("number" !== typeof p[q].y)
                                    0 < q && !t && (m.connectNullData ? b.setLineDash && (0 < y.length && (m.options.nullDataLineDashType || !p[q - 1].lineDashType)) && (y[y.length - 1].newLineDashArray = A,
                                    C = m.nullDataLineDashType) : (d(),
                                    y = [])),
                                    t = !0;
                                else {
                                    ...
                                    q < p.length - 1 && (G !== (p[q].lineColor || z) || C !== (p[q].lineDashType || m.lineDashType)) && (G = p[q].lineColor || z,
                                    y[y.length - 1].newStrokeStyle = G,
                                    b.setLineDash && (p[q].lineDashType ? (C = p[q].lineDashType,
                                    y[y.length - 1].newLineDashArray = J(C, m.lineThickness)) : (C = m.lineDashType,
        ...
        n.prototype.renderStepArea = function(a) {
            ...
            var e = a.targetCanvasCtx || this.plotArea.ctx
              , f = w ? this._preRenderCtx : e;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var l = this._eventManager.ghostCtx, s = a.axisY.lineCoordinates, h = [], k = this.plotArea, m;
                f.save();
                w && l.save();
                f.beginPath();
                f.rect(k.x1, k.y1, k.width, k.height);
                ...
                for (var p = 0; p < a.dataSeriesIndexes.length; p++) {
                    ...
                    if (0 < t.length) {
                        ...
                        for (; r < t.length; r++)
                            if (y = t[r].x.getTime ? t[r].x.getTime() : t[r].x,
                            !(y < a.axisX.dataInfo.viewPortMin || y > a.axisX.dataInfo.viewPortMax && (!g.connectNullData || !c))) {
                                var Z = u;
                                "number" !== typeof t[r].y ? (g.connectNullData || (c || d) || b(),
                                c = !0) : (n = a.axisX.convertValueToPixel(y),
                                u = a.axisY.convertValueToPixel(t[r].y),
                                d || c ? (!d && g.connectNullData ? (f.setLineDash && (g.options.nullDataLineDashType || M === g.lineDashType && g.lineDashType !== g.nullDataLineDashType) && (d = n,
                                c = u,
                                n = m.x,
                                u = m.y,
                                b(),
                                ...
                                r < t.length - 1 && (A !== (t[r].lineColor || v) || M !== (t[r].lineDashType || g.lineDashType)) && (b(),
                                A = t[r].lineColor || v,
                                f.strokeStyle = A,
                                f.setLineDash && (t[r].lineDashType ? (M = t[r].lineDashType,
                                f.setLineDash(J(M, g.lineThickness))) : (M = g.lineDashType,
                                f.setLineDash(ca)))),
                                y = g.dataPointIds[r],
                                ...
                                0 !== t[r].markerSize && (0 < t[r].markerSize || 0 < g.markerSize) && (Z = g.getMarkerProperties(r, n, u, f),
                                h.push(Z),
                                y = Q(y),
                                w && h.push({
                                    x: n,
        ...
        n.prototype.renderStackedArea = function(a) {
            ...
            var c = a.targetCanvasCtx || this.plotArea.ctx
              , b = w ? this._preRenderCtx : c;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var e = null, f = null, l = [], s = this.plotArea, h = [], k = [], m = [], p = [], q = 0, g, t, r = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), n = this._eventManager.ghostCtx, u, y, x;
                w && n.beginPath();
                b.save();
                w && n.save();
                b.beginPath();
                            ...
                            if (!(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax && (!C.connectNullData || !Z)))
                                if ("number" !== typeof ia.y)
                                    ...
                                    if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length) {
                                        ...
                                        t = a.axisY.convertValueToPixel(ia.y),
                                        t -= oa;
                                    k.push({
                                        x: g,
                                        y: r - oa
                                    ...
                                    h[f] = r - t;
                                    y || Z ? (!y && C.connectNullData ? (b.setLineDash && (C.options.nullDataLineDashType || x === C.lineDashType && C.lineDashType !== C.nullDataLineDashType) && (y = k.pop(),
                                    x = k[k.length - 1],
                                    d(),
                                    b.moveTo(u.x, u.y),
                                    k.push(x),
                                    ...
                                    q < v.length - 1 && (M !== (v[q].lineColor || A) || x !== (v[q].lineDashType || C.lineDashType)) && (d(),
                                    b.beginPath(),
                                    b.moveTo(g, t),
                                    k.push({
                                        x: g,
                                    ...
                                    M = v[q].lineColor || A,
                                    b.strokeStyle = M,
                                    b.setLineDash && (v[q].lineDashType ? (x = v[q].lineDashType,
                                    b.setLineDash(J(x, C.lineThickness))) : (x = C.lineDashType,
                                    b.setLineDash(ca))));
                                    ...
                                    0 <= C.dataPointIndexes[f] && 0 !== ia.markerSize && (0 < ia.markerSize || 0 < C.markerSize) && (oa = C.getMarkerProperties(C.dataPointIndexes[f], g, t, b),
                                    l.push(oa),
                                    f = Q(B),
                                    w && l.push({
                                        x: g,
        ...
        n.prototype.renderStackedArea100 = function(a) {
            ...
            var c = a.targetCanvasCtx || this.plotArea.ctx
              , b = w ? this._preRenderCtx : c;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var e = null, f = null, l = this.plotArea, s = [], h = [], k = [], m = [], p = [], q = 0, g, t, r, n, u, y = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), x = this._eventManager.ghostCtx;
                b.save();
                w && x.save();
                b.beginPath();
                ...
                b.clip();
                w && (x.beginPath(),
                x.rect(l.x1, l.y1, l.width, l.height),
                x.clip());
                for (var e = [], z = 0; z < a.dataSeriesIndexes.length; z++) {
                    var G = a.dataSeriesIndexes[z]
                      , C = this.data[G]
                            ...
                            if (!(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax && (!C.connectNullData || !Z)))
                                if ("number" !== typeof ia.y)
                                    ...
                                    if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length) {
                                        ...
                                        t = a.axisY.convertValueToPixel(oa),
                                        t -= na;
                                    k.push({
                                        x: g,
                                        y: y - na
                                    ...
                                    h[f] = y - t;
                                    n || Z ? (!n && C.connectNullData ? (b.setLineDash && (C.options.nullDataLineDashType || u === C.lineDashType && C.lineDashType !== C.nullDataLineDashType) && (n = k.pop(),
                                    u = k[k.length - 1],
                                    d(),
                                    b.moveTo(r.x, r.y),
                                    k.push(u),
                                    ...
                                    q < v.length - 1 && (M !== (v[q].lineColor || A) || u !== (v[q].lineDashType || C.lineDashType)) && (d(),
                                    b.beginPath(),
                                    b.moveTo(g, t),
                                    k.push({
                                        x: g,
                                    ...
                                    M = v[q].lineColor || A,
                                    b.strokeStyle = M,
                                    b.setLineDash && (v[q].lineDashType ? (u = v[q].lineDashType,
                                    b.setLineDash(J(u, C.lineThickness))) : (u = C.lineDashType,
                                    b.setLineDash(B))));
                                    if (0 <= C.dataPointIndexes[f]) {
                                    ...
                                    0 <= C.dataPointIndexes[f] && 0 !== ia.markerSize && (0 < ia.markerSize || 0 < C.markerSize) && (na = C.getMarkerProperties(q, g, t, b),
                                    s.push(na),
                                    f = Q(F),
                                    w && s.push({
                                        x: g,
                ...
                for (var s = 0; s < a.dataSeriesIndexes.length; s++) {
                    ...
                    if (0 < m.length) {
                        ...
                        for (var p = 0, q = 0, e = 0; e < m.length; e++)
                            if (f = m[e].getTime ? f = m[e].x.getTime() : f = m[e].x,
                            !(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax) && "number" === typeof m[e].y) {
                                f = a.axisX.convertValueToPixel(f);
                                ...
                                c.globalAlpha = 1;
                                Math.sqrt((p - f) * (p - f) + (q - l) * (q - l)) < Math.min(g.size, 5) && m.length > Math.min(this.plotArea.width, this.plotArea.height) || (p = k.dataPointIds[e],
                                ...
                                p = Q(p),
                                w && aa.drawMarker(g.x, g.y, this._eventManager.ghostCtx, g.type, g.size, p, p, g.borderThickness),
                                (m[e].indexLabel || k.indexLabel || m[e].indexLabelFormatter || k.indexLabelFormatter) && this._indexLabels.push({
                                    chartType: "scatter",
                                    dataPoint: m[e],
                                    dataSeries: k,
                                    point: {
        ...
        n.prototype.renderCandlestick = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var e = null, f = null, l = this.plotArea, s = 0, h, k, m, p, q, g, e = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1, f = this.options.dataPointMaxWidth ? this.dataPointMaxWidth : this.options.dataPointWidth ? this.dataPointWidth : 0.015 * this.width, t = a.axisX.dataInfo.minDiff;
                isFinite(t) || (t = 0.3 * Math.abs(a.axisX.range));
                ...
                for (var n = 0; n < a.dataSeriesIndexes.length; n++) {
                    ...
                    if (0 < y.length)
                        for (var x = 5 < t && u.bevelEnabled ? !0 : !1, s = 0; s < y.length; s++)
                            if (y[s].getTime ? g = y[s].x.getTime() : g = y[s].x,
                            !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax) && !r(y[s].y) && y[s].y.length && "number" === typeof y[s].y[0] && "number" === typeof y[s].y[1] && "number" === typeof y[s].y[2] && "number" === typeof y[s].y[3]) {
                                ...
                                "candlestick" === u.type ? (c.moveTo(h - v, m),
                                c.lineTo(h - v, Math.min(k, q)),
                                c.stroke(),
                                c.moveTo(h - v, Math.max(k, q)),
                                c.lineTo(h - v, p),
                                c.stroke(),
                                da(c, z, Math.min(k, q), G, Math.max(k, q), y[s].y[0] <= y[s].y[3] ? u.risingColor : f, C, e, x, x, !1, !1, u.fillOpacity),
                                w && (e = Q(A),
                                b.strokeStyle = e,
                                b.moveTo(h - v, m),
                                ...
                                b.lineTo(h - v, p),
                                b.stroke(),
                                da(b, z, Math.min(k, q), G, Math.max(k, q), e, 0, null, !1, !1, !1, !1))) : "ohlc" === u.type && (c.moveTo(h - v, m),
                                c.lineTo(h - v, p),
                                c.stroke(),
                                c.beginPath(),
                                c.moveTo(h, k),
        ...
        n.prototype.renderBoxAndWhisker = function(a) {
            var d = a.targetCanvasCtx || this.plotArea.ctx
              ...
              , b = this._eventManager.ghostCtx;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var e = null, f = this.plotArea, l = 0, s, h, k, m, p, q, g, e = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1, l = this.options.dataPointMaxWidth ? this.dataPointMaxWidth : this.options.dataPointWidth ? this.dataPointWidth : 0.015 * this.width, t = a.axisX.dataInfo.minDiff;
                isFinite(t) || (t = 0.3 * Math.abs(a.axisX.range));
                ...
                for (var n = !1, n = !!a.axisY.reversed, fa = 0; fa < a.dataSeriesIndexes.length; fa++) {
                    ...
                    if (0 < x.length)
                        for (var z = 5 < t && y.bevelEnabled ? !0 : !1, l = 0; l < x.length; l++)
                            ...
                            !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax) && !r(x[l].y) && x[l].y.length && "number" === typeof x[l].y[0] && "number" === typeof x[l].y[1] && "number" === typeof x[l].y[2] && "number" === typeof x[l].y[3] && "number" === typeof x[l].y[4] && 5 === x[l].y.length) {
                                ...
                                b.strokeStyle = e,
                                b.lineWidth = na,
                                0 < na && (b.moveTo(s - B - F, k),
                                b.lineTo(s - B - F, Math.max(h, p)),
                                b.stroke(),
                                b.moveTo(s - B - F, Math.min(h, p)),
                                b.lineTo(s - B - F, m),
                                b.stroke()),
                                da(b, v, Math.max(k, m), C, Math.min(k, m), e, 0, null, !1, !1, !1, !1),
                                0 < S && (b.beginPath(),
                                b.lineWidth = S,
                                b.moveTo(s + Z / 2, p - ia),
                                b.lineTo(s - Z / 2, p - ia),
        ...
        n.prototype.renderRangeColumn = function(a) {
            var d = a.targetCanvasCtx || this.plotArea.ctx
              , c = w ? this._preRenderCtx : d;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var b = null, e = this.plotArea, f = 0, l, s, h, f = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1;
                ...
                for (var m = 0; m < a.dataSeriesIndexes.length; m++) {
                    ...
                    if (0 < g.length)
                        for (var t = 5 < k && q.bevelEnabled ? !0 : !1, f = 0; f < g.length; f++)
                            ...
                            !(h < a.axisX.dataInfo.viewPortMin || h > a.axisX.dataInfo.viewPortMax) && !r(g[f].y) && g[f].y.length && "number" === typeof g[f].y[0] && "number" === typeof g[f].y[1]) {
                                ...
                                da(c, a.axisX.reversed ? fa : n, l, a.axisX.reversed ? n : fa, s, b, 0, b, t, t, !1, !1, q.fillOpacity);
                                b = Q(u);
        ...
        n.prototype.renderError = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var e = null, f = !1, l = this.plotArea, s = 0, h, k, m, p, q, g, t, n = a.axisX.dataInfo.minDiff;
                ...
                for (var y = 0; y < a.dataSeriesIndexes.length; y++) {
                    ...
                    if (C)
                        ...
                        u = 0; u < e; u++)
                            !this.data[u].type.match(/(bar|column)/ig) || !this.data[u].visible || this.data[u].type.match(/(stacked)/ig) && A || (this.data[u].type.match(/(range)/ig) && (f = !0),
                            A++);
                    ...
                    u = this.options.dataPointWidth ? this.dataPointWidth : 0.9 * ((b ? l.height : l.width) * (a.axisX.logarithmic ? Math.log(n) / Math.log(a.axisX.range) : Math.abs(n) / Math.abs(a.axisX.range)) / (C ? fa : 1)) << 0;
                    ...
                    if (0 < v.length)
                        for (var E = z._colorSet, s = 0; s < v.length; s++) {
                            ...
                            if (!(t < a.axisX.dataInfo.viewPortMin || t > a.axisX.dataInfo.viewPortMax) && !r(v[s].y) && v[s].y.length && "number" === typeof v[s].y[0] && "number" === typeof v[s].y[1]) {
                                ...
                                b ? p = ca : g = ca;
                                b ? (q = a.axisX.reversed ? k + (C ? fa : 1) * u / 2 - (C ? A - 1 : 0) * u << 0 : k - (C ? fa : 1) * u / 2 + (C ? A - 1 : 0) * u << 0,
                                g = a.axisX.reversed ? q - u << 0 : q + u << 0) : (m = a.axisX.reversed ? h + (C ? fa : 1) * u / 2 - (C ? A - 1 : 0) * u << 0 : h - (C ? fa : 1) * u / 2 + (C ? A - 1 : 0) * u << 0,
                                ...
                                if (v[s].indexLabel || z.indexLabel || v[s].indexLabelFormatter || z.indexLabelFormatter)
                                    this._indexLabels.push({
                                        chartType: "error",
                                        dataPoint: v[s],
                                        dataSeries: z,
        ...
        n.prototype.renderRangeBar = function(a) {
            var d = a.targetCanvasCtx || this.plotArea.ctx
              , c = w ? this._preRenderCtx : d;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var b = null, e = this.plotArea, f = 0, l, s, h, k, f = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1;
                ...
                for (var p = 0; p < a.dataSeriesIndexes.length; p++) {
                    ...
                    if (0 < t.length) {
                        ...
                        c.strokeStyle = "#4572A7 ";
                        for (f = 0; f < t.length; f++)
                            if (t[f].getTime ? k = t[f].x.getTime() : k = t[f].x,
                            !(k < a.axisX.dataInfo.viewPortMin || k > a.axisX.dataInfo.viewPortMax) && !r(t[f].y) && t[f].y.length && "number" === typeof t[f].y[0] && "number" === typeof t[f].y[1]) {
                                ...
                                b = Q(b);
                                w && da(this._eventManager.ghostCtx, l, a.axisX.reversed ? v : h, s, a.axisX.reversed ? h : v, b, 0, null, !1, !1, !1, !1);
                ...
                for (var s = 0; s < a.dataSeriesIndexes.length; s++) {
                    ...
                    if (0 < p.length) {
                        ...
                        for (var M = !0; g < p.length; g++)
                            if (u = p[g].x.getTime ? p[g].x.getTime() : p[g].x,
                            !(u < a.axisX.dataInfo.viewPortMin || u > a.axisX.dataInfo.viewPortMax && (!m.connectNullData || !M)))
                                if (null !== p[g].y && p[g].y.length && "number" === typeof p[g].y[0] && "number" === typeof p[g].y[1]) {
                                    ...
                                    q || M ? (m.connectNullData && !q ? (b.setLineDash && (m.options.nullDataLineDashType || C === m.lineDashType && m.lineDashType !== m.nullDataLineDashType) && (h[h.length - 1].newLineDashArray = E,
                                    ...
                                    g < p.length - 1 && (A !== (p[g].lineColor || v) || C !== (p[g].lineDashType || m.lineDashType)) && (d(),
                                    A = p[g].lineColor || v,
                                    h[h.length - 1].newStrokeStyle = A,
                                    b.strokeStyle = A,
                                    b.setLineDash && (p[g].lineDashType ? (C = p[g].lineDashType,
                                    h[h.length - 1].newLineDashArray = J(C, m.lineThickness),
                                    b.setLineDash(h[h.length - 1].newLineDashArray)) : (C = m.lineDashType,
                ...
                for (var s = 0; s < a.dataSeriesIndexes.length; s++) {
                    ...
                    if (0 < m.length) {
                        ...
                        for (g = !1; p < m.length; p++)
                            if (q = m[p].x.getTime ? m[p].x.getTime() : m[p].x,
                            !(q < a.axisX.dataInfo.viewPortMin || q > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !g)))
                                if (null !== m[p].y && m[p].y.length && "number" === typeof m[p].y[0] && "number" === typeof m[p].y[1]) {
                                    ...
                                    p < m.length - 1 && (x !== (m[p].lineColor || y) || z !== (m[p].lineDashType || k.lineDashType)) && (x = m[p].lineColor || y,
                                    r[r.length - 1].newStrokeStyle = x,
                                    b.setLineDash && (m[p].lineDashType ? (z = m[p].lineDashType,
                                    r[r.length - 1].newLineDashArray = J(z, k.lineThickness)) : (z = k.lineDashType,
                                    ...
                                    0 < p && !g && (k.connectNullData ? b.setLineDash && (0 < r.length && (k.options.nullDataLineDashType || !m[p - 1].lineDashType)) && (r[r.length - 1].newLineDashArray = C,
        ...
        n.prototype.renderWaterfall = function(a) {
            var d = a.targetCanvasCtx || this.plotArea.ctx
              , c = w ? this._preRenderCtx : d;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var b = this._eventManager.ghostCtx, e = null, f = this.plotArea, l = 0, s, h, k, m, p = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), l = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1;
                ...
                for (var g = 0; g < a.dataSeriesIndexes.length; g++) {
                    ...
                    if (0 < n.length)
                        for (var x = 5 < q && r.bevelEnabled ? !0 : !1, v = !1, A = null, C = null, l = 0; l < n.length; l++)
                            if (n[l].getTime ? m = n[l].x.getTime() : m = n[l].x,
                            "number" !== typeof n[l].y) {
                                if (0 < l && !v && r.connectNullData)
                                    var B = r.options.nullDataLineDashType || !n[l - 1].lineDashType ? r.nullDataLineDashType : n[l - 1].lineDashType;
                                v = !0
                            } else {
                                ...
                                e = Q(e);
                                w && da(this._eventManager.ghostCtx, a.axisX.reversed ? E : s, h, a.axisX.reversed ? s : E, k, e, 0, null, !1, !1, !1, !1);
                                var S, M = s;
                                ...
                                0 < l && A && (!v || r.connectNullData) && (v && c.setLineDash && c.setLineDash(J(B, u)),
                                c.beginPath(),
                                c.moveTo(A, C - y),
                                c.lineTo(M, S - y),
                                0 < u && c.stroke(),
                                ...
                                A = E;
                                C = 0 < n[l].y ? h : k;
                                M = n[l].lineDashType ? n[l].lineDashType : r.options.lineDashType ? r.options.lineDashType : "shortDash";
                                c.strokeStyle = n[l].lineColor ? n[l].lineColor : r.options.lineColor ? r.options.lineColor : "#9e9e9e";
                                c.lineWidth = u;
                                c.setLineDash && (M = J(M, u),
                                c.setLineDash(M));
        ...
        n.prototype.renderPie = function(a) {
            function d() {
                if (k && m) {
                    for (var a = 0, b = 0, c = 0, d = 0, e = 0; e < m.length; e++) {
                        ...
                        p = f.indexLabelFormatter ? f.indexLabelFormatter(s) : f.indexLabel ? n.replaceKeywordsWithValue(f.indexLabel, f, k, e) : k.indexLabelFormatter ? k.indexLabelFormatter(s) : k.indexLabel ? n.replaceKeywordsWithValue(k.indexLabel, f, k, e) : f.label ? f.label : "";
                    ...
                    for (e = 0; e < m.length; e++)
                        h = g[(c + e) % m.length],
                        1 < a && (h.midAngle > Math.PI / 2 - u && h.midAngle < Math.PI / 2 + u) && (f <= a / 2 && !p ? (h.hemisphere = "right",
                        f++) : (h.hemisphere = "left",
                        p = !0));
                    p = !1;
                    for (e = 0; e < m.length; e++)
                        h = g[(d + e) % m.length],
                        1 < b && (h.midAngle > 3 * Math.PI / 2 - u && h.midAngle < 3 * Math.PI / 2 + u) && (l <= b / 2 && !p ? (h.hemisphere = "left",
                        l++) : (h.hemisphere = "right",
                        p = !0))
                }
            }
            function c(a) {
                ...
                for (b = b = 0; b < m.length; b++)
                    ...
                    a.setLineDash && a.setLineDash(J(c.indexLabelLineDashType, c.indexLabelLineThickness)),
                    a.beginPath(),
                    a.moveTo(d, e),
            ...
            function f(a, c, d) {
                ...
                if (0 <= a && a < m.length) {
                    ...
                    l && (d = p.indexLabelTextBlock.y + l,
                    c = 0,
                    c = "right" === p.hemisphere ? x.x + Math.sqrt(Math.pow(w, 2) - Math.pow(d - x.y, 2)) : x.x - Math.sqrt(Math.pow(w, 2) - Math.pow(d - x.y, 2)),
                    p.midAngle > Math.PI / 2 - u && p.midAngle < Math.PI / 2 + u ? (k = (a - 1 + g.length) % g.length,
                    k = g[k],
                    a = g[(a + 1 + g.length) % g.length],
                    "left" === p.hemisphere && "right" === k.hemisphere && c > k.indexLabelTextBlock.x ? c = k.indexLabelTextBlock.x - 15 : "right" === p.hemisphere && ("left" === a.hemisphere && c < a.indexLabelTextBlock.x) && (c = a.indexLabelTextBlock.x + 15)) : p.midAngle > 3 * Math.PI / 2 - u && p.midAngle < 3 * Math.PI / 2 + u && (k = (a - 1 + g.length) % g.length,
                    k = g[k],
                    a = g[(a + 1 + g.length) % g.length],
                ...
                for (var c = a = 0, d = 0, l = !0, c = 0; 10 > c && (1 > c || 0 < d); c++) {
                        ...
                        for (var s, r, a = 0; a < m.length; a++) {
                            ...
                            if (null !== u) {
                                ...
                                if (0 > z) {
                                    ...
                                    var A = -1 * (z - r)
                                      , J = G = 0;
                                    "right" === h.hemisphere ? (G = f(a, r),
                                    A = -1 * (z - G),
                                    J = f(u, A),
                                    +J.toFixed(y) < +A.toFixed(y) && +G.toFixed(y) <= +r.toFixed(y) && f(a, -(A - J))) : (G = f(u, r),
                                    A = -1 * (z - G),
                                    J = f(a, A),
                                    +J.toFixed(y) < +A.toFixed(y) && +G.toFixed(y) <= +r.toFixed(y) && f(u, -(A - J)))
                                }
                            }
                        }
                    } else
                    ...
                    for (a = 0; a < m.length; a++)
                        ...
                        0 !== u.height && 0 !== u.width)
                            u = u = 0,
                            "right" === h.hemisphere ? (u = q.x2 - (h.indexLabelTextBlock.x + h.indexLabelTextBlock.width + p),
                            u *= -1) : u = q.x1 - (h.indexLabelTextBlock.x - h.indexLabelTextBlock.width - p),
                            ...
                            Math.abs(h.indexLabelTextBlock.y - h.indexLabelTextBlock.height / 2 - x.y) < C || Math.abs(h.indexLabelTextBlock.y + h.indexLabelTextBlock.height / 2 - x.y) < C) && (u /= Math.abs(Math.cos(h.indexLabelAngle)),
                            9 < u && (u *= 0.3),
                            u > d && (d = u)),
                            u = u = 0,
                            0 < h.indexLabelAngle && h.indexLabelAngle < Math.PI ? (u = q.y2 - (h.indexLabelTextBlock.y + h.indexLabelTextBlock.height / 2 + 5),
                            u *= -1) : u = q.y1 - (h.indexLabelTextBlock.y - h.indexLabelTextBlock.height / 2 - 5),
                            0 < u && (!l && h.indexLabelText && (r = 0 < h.indexLabelAngle && h.indexLabelAngle < Math.PI ? -1 : 1,
                            0 === f(a, u * r) && f(a, 2 * r)),
                            Math.abs(h.indexLabelTextBlock.x - x.x) < C && (u /= Math.abs(Math.sin(h.indexLabelAngle)),
                            9 < u && (u *= 0.3),
                            u > d && (d = u)));
                    var L = function(a, b, c) {
                        for (var d = [], e = 0; d.push(g[b]),
                        b !== c; b = (b + 1 + m.length) % m.length)
                            ;
                        d.sort(function(a, b) {
                            return a.y - b.y
                        });
                        ...
                        for (var a = -1, c = -1, d = 0, f = !1, k = 0; k < m.length; k++)
                            ...
                            s.indexLabelText) {
                                ...
                                if (null !== l) {
                                    ...
                                    l !== a && (c = l,
                                    d += -z),
                                    0 === k % Math.max(m.length / 10, 3) && (f = !0)) : f = !0;
                                    f && (0 < d && 0 <= a && 0 <= c) && (L(d, a, c),
                                    c = a = -1,
                                    d = 0)
                                }
                            }
            ...
            var n = this;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var k = this.data[a.dataSeriesIndexes[0]], m = k.dataPoints, p = 10, q = this.plotArea, g = k.dataPointEOs, t = 2, w, v = 1.3, u = 20 / 180 * Math.PI, y = 6, x = {
                    x: (q.x2 + q.x1) / 2,
                    y: (q.y2 + q.y1) / 2
                }, z = 0;
                a = !1;
                ...
                if (0 !== z) {
                    ...
                    this.pieDoughnutClickHandler = function(a) {
                        n.isAnimating || !r(a.dataSeries.explodeOnClick) && !a.dataSeries.explodeOnClick || (a = a.dataPoint,
        ...
        n.prototype.renderFunnel = function(a) {
            ...
            function c() {
                ...
                for (var l = d[0] = 0, h = 0, m, p, b = b - a, l = !1, k = 0; k < y.length; k++)
                    ...
                    l ? m = 0 == Number(c.toFixed(3)) ? 0 : a / c : (p = ba * ba * b * b - 4 * Math.abs(ba) * a,
                    0 > p ? (p = c,
                    l = (b + p) * (e - h) / 2,
                    a -= l,
                    m = e - h,
                    ...
                    m += 0 == p ? 0 : a / p,
                    h += a / p,
                    l = !0) : (m = (Math.abs(ba) * b - Math.sqrt(p)) / 2,
                    p = b - 2 * m / Math.abs(ba),
                    h += m,
                    h > e && (h -= m,
                    p = c,
            ...
            function b() {
                if (u && y) {
                    for (var a, b, c, d, e, f, k, l, h, m, p, q, s, t, n, D = [], x = [], v = {
                        ...
                        n = R[C],
                        n = "undefined" !== typeof n.x5 ? (n.y2 + n.y4) / 2 : (n.y2 + n.y3) / 2,
                        n = g(n).x2 + 1,
                        D[C] = K - n - W;
                    n = 0.5 * W;
                    for (var C = 0, B = y.length - 1; C < y.length || 0 <= B; C++,
                    B--) {
                        ...
                        "inside" === u.indexLabelPlacement && (D[C] = C !== da ? u.reversed ? R[C].x2 - R[C].x1 : R[C].x3 - R[C].x4 : R[C].x3 - R[C].x6,
                        20 > D[C] && (D[C] = C !== da ? u.reversed ? R[C].x3 - R[C].x4 : R[C].x2 - R[C].x1 : R[C].x2 - R[C].x1,
                        D[C] /= 2));
            ...
            function e() {
                ...
                if (e)
                    for (l = H.length - 1; 0 <= l; l--)
                        ...
                        u.reversed ? (H[l].textBlock.y + H[l].height > pa + z && (H[l].textBlock.y = pa + z - H[l].height),
                        H[l].textBlock.y < ua - z && (H[l].textBlock.y = ua - z)) : (H[l].textBlock.y < pa - z && (H[l].textBlock.y = pa - z),
                        H[l].textBlock.y + H[l].height > ua + z && (H[l].textBlock.y = ua + z - H[l].height))
            }
            function f() {
                var a, b, c, d;
                if ("inside" !== u.indexLabelPlacement)
                    for (var e = 0; e < R.length; e++)
                        0 == H[e].textBlock.text.length ? H[e].isDirty = !0 : (a = R[e],
                        c = "undefined" !== typeof a.x5 ? (a.y2 + a.y4) / 2 : (a.y2 + a.y3) / 2,
                        b = u.reversed ? "undefined" !== typeof a.x5 ? c > U ? g(c).x2 + 1 : (a.x2 + a.x3) / 2 + 1 : (a.x2 + a.x3) / 2 + 1 : "undefined" !== typeof a.x5 ? c < U ? g(c).x2 + 1 : (a.x4 + a.x3) / 2 + 1 : (a.x2 + a.x3) / 2 + 1,
                        H[e].textBlock.x = b + W,
                        H[e].textBlock.y = c - H[e].height / 2,
                        u.reversed ? (H[e].textBlock.y + H[e].height > pa + z && (H[e].textBlock.y = pa + z - H[e].height),
                        H[e].textBlock.y < ua - z && (H[e].textBlock.y = ua - z)) : (H[e].textBlock.y < pa - z && (H[e].textBlock.y = pa - z),
                        H[e].textBlock.y + H[e].height > ua + z && (H[e].textBlock.y = ua + z - H[e].height)));
                else
            ...
            function l() {
                ...
                function b() {
                    ...
                    for (var k, h = 1; h < l; h++) {
                        ...
                        for (var s = H.length - 1; 0 <= s; s--)
                            !H[s].isDirty && (H[s].textBlock.y < e && H[s].textBlock.y + H[s].height > e) && (k = q(s),
                            !(k >= H.length - 1) && H[s].textBlock.y + H[s].height + ea > H[k].textBlock.y && (H[s].textBlock.y = H[s].textBlock.y + H[s].height - e > e - H[s].textBlock.y ? e + 1 : e - H[s].height - 1))
                    }
                ...
                for (var d, e, f, g, l, k, m = 1, r = 0; r < 2 * m; r++) {
                    for (var n = H.length - 1; 0 <= n && !(0 <= p(n) && p(n),
                    f = H[n],
                    g = f.textBlock,
                    k = (l = q(n) < R.length ? H[q(n)] : null) ? l.textBlock : null,
                    d = +f.height.toFixed(6),
                    e = +g.y.toFixed(6),
                    !f.isDirty && (l && e + d + ea > +k.y.toFixed(6)) && (d = g.y + d + ea - k.y,
                    e = a(n, -d),
                    e < d && (0 < e && (d -= e),
                    e = a(q(n), d),
                    e != d))); n--)
            ...
            function n(a, b, c) {
                var d, e, g, l = [], h = z, p = [];
                -1 !== b && (0 <= X.indexOf(b) ? (e = X.indexOf(b),
                X.splice(e, 1)) : (X.push(b),
                ...
                a._animator.animate(0, c, function(c) {
                    ...
                    for (e = 0; e < R.length; e++)
                        ta(d, R[e], u.fillOpacity);
                    v(d);
                    M && ("inside" !== u.indexLabelPlacement ? m(d) : f(),
                    t(d));
                    1 <= c && (ha = !1)
            ...
            function m(a) {
                for (var b, c, d, e, f = 0; f < R.length; f++)
                    ...
                    a.setLineDash && a.setLineDash(J(H[f].lineDashType, H[f].lineThickness)),
                    a.beginPath(),
                    a.moveTo(b, c),
                    a.lineTo(d, e),
                    a.stroke())
            ...
            function v(a) {
                ...
                a.roundRect || Ca(a);
                A.title && (A.title.dockInsidePlotArea || "center" === A.title.horizontalAlign && "center" === A.title.verticalAlign) && (A.title.ctx = a,
                A.title.render());
                if (A.subtitles)
                ...
                A.legend && (A.legend.dockInsidePlotArea || "center" === A.legend.horizontalAlign && "center" === A.legend.verticalAlign) && (A.legend.ctx = a,
                A.legend.setLayout(),
                A.legend.render());
                T.fNg && T.fNg(A)
            }
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                for (var u = this.data[a.dataSeriesIndexes[0]], y = u.dataPoints, x = this.plotArea, z = 0.025 * x.width, B = 0.01 * x.width, C = 0, E = x.height - 2 * z, I = Math.min(x.width - 2 * B, 2.8 * x.height), M = !1, S = 0; S < y.length; S++)
                    if (!M && ("undefined" !== typeof y[S].indexLabel && null !== y[S].indexLabel && 0 < y[S].indexLabel.toString().length) && (M = !0),
                    !M && ("undefined" !== typeof y[S].label && null !== y[S].label && 0 < y[S].label.toString().length) && (M = !0),
                    !M && "function" === typeof u.indexLabelFormatter || "function" === typeof y[S].indexLabelFormatter)
                        M = !0;
                ...
                if (0 != u.length && (u.dataPoints && u.visible) && 0 !== y.length) {
                    ...
                    a = 75 * I / 100;
                    var W = 30 * (K - a) / 100;
                    "funnel" === u.type ? (Q = r(u.options.neckHeight) ? 0.35 * E : u.neckHeight,
                    F = r(u.options.neckWidth) ? 0.25 * a : u.neckWidth,
                    "string" === typeof Q && Q.match(/%$/) ? (Q = parseInt(Q),
                    Q = Q * E / 100) : Q = parseInt(Q),
                    "string" === typeof F && F.match(/%$/) ? (F = parseInt(F),
                    F = F * a / 100) : F = parseInt(F),
                    Q > E ? Q = E : 0 >= Q && (Q = 0),
                    F > a ? F = a - 0.5 : 0 >= F && (F = 0)) : "pyramid" === u.type && (F = Q = 0,
                    ...
                    var B = S + a / 2
                      ...
                      , ua = u.reversed ? Z : P;
                    a = [];
                    var B = [], R = [], I = [], $ = Z, da, ba = (U - pa) / (L - V), ga = -ba, S = "area" === (u.valueRepresents ? u.valueRepresents : "height") ? c() : d();
                    if (-1 !== S) {
                        if (u.reversed)
                            for (I.push($),
                            F = S.length - 1; 0 < F; F--)
                        ...
                        if (u.reversed)
                            for (F = 0; F < S.length; F++)
                                I[F] < U ? (a.push(L),
                                B.push(aa),
                                da = F) : (a.push((I[F] - pa + ba * V) / ba),
                                B.push((I[F] - pa + ga * Y) / ga));
                        else
                            for (F = 0; F < S.length; F++)
                                I[F] < U ? (a.push((I[F] - pa + ba * V) / ba),
                                B.push((I[F] - pa + ga * Y) / ga),
                                da = F) : (a.push(L),
                                B.push(aa));
                        for (F = 0; F < S.length - 1; F++)
                            $ = u.reversed ? y[y.length - 1 - F].color ? y[y.length - 1 - F].color : u._colorSet[(y.length - 1 - F) % u._colorSet.length] : y[F].color ? y[F].color : u._colorSet[F % u._colorSet.length],
                            F === da ? R.push({
                                x1: a[F],
                                y1: I[F],
                                x2: B[F],
                        ...
                        for (F = 0; F < y.length; F++)
                            y[F].exploded && (S = !0,
                            u.reversed ? X.push(y.length - 1 - F) : X.push(F));
                        ...
                        for (F = 0; F < R.length; F++)
                            C = R[F],
                            ta(O, C, u.fillOpacity),
                            ja.push(C.y1);
                        v(O);
                        M && u.visible && ("inside" === u.indexLabelPlacement || A.animationEnabled || m(O),
                        ...
                        this.funnelPyramidClickHandler = function(a) {
                            var b = -1;
                            if (!ha && !A.isAnimating && (r(a.dataSeries.explodeOnClick) || a.dataSeries.explodeOnClick) && (b = u.reversed ? y.length - 1 - a.dataPointIndex : a.dataPointIndex,
                            0 <= b)) {
                                a = b;
        ...
        n.prototype.set = function(a, d, c) {
            ...
            c && this.render()) : n.base.set.call(this, a, d, c)
        }
        ;
                ...
                if ("x" === a)
                    if (c.axisX && "dateTime" === c.axisX.valueType || "dateTime" === c.xValueType || d.x && d.x.getTime) {
                        if (!c.axisX.logarithmic)
                            return Ba(g, d.xValueFormatString ? d.xValueFormatString : c.xValueFormatString ? c.xValueFormatString : c.xValueFormatString = f.axisX && f.axisX.autoValueFormatString ? f.axisX.autoValueFormatString : "DD MMM YY", f._cultureInfo)
                    } else
                        return ha(g, d.xValueFormatString ? d.xValueFormatString : c.xValueFormatString ? c.xValueFormatString : c.xValueFormatString = "#,##0.########", f._cultureInfo);
                else
                    return "y" === a ? ha(g, d.yValueFormatString ? d.yValueFormatString : c.yValueFormatString ? c.yValueFormatString : c.yValueFormatString = "#,##0.########", f._cultureInfo) : "z" === a ? ha(g, d.zValueFormatString ? d.zValueFormatString : c.zValueFormatString ? c.zValueFormatString : c.zValueFormatString = "#,##0.########", f._cultureInfo) : g
            })
        }
        ;
        qa(O, $);
            ...
            for (var m = 0; m < this.dataSeries.length; m++) {
                ...
                if (p.dataPoints && p.dataPoints.length)
                    if ("pie" !== p.type && "doughnut" !== p.type && "funnel" !== p.type && "pyramid" !== p.type) {
                        var q = p.legendMarkerType = p.legendMarkerType ? p.legendMarkerType : "line" !== p.type && "stepLine" !== p.type && "spline" !== p.type && "scatter" !== p.type && "bubble" !== p.type || !p.markerType ? "error" === p.type && p._linkedSeries ? p._linkedSeries.legendMarkerType ? p._linkedSeries.legendMarkerType : W.getDefaultLegendMarker(p._linkedSeries.type) : W.getDefaultLegendMarker(p.type) : p.markerType
                ...
                if (0 <= f && f < this.dataPoints.length) {
                    ...
                    if (q) {
                        ...
                        case "doughnut":
                            ...
                            r < q.radius && r > v && (r = Math.atan2(d - w.y, a - w.x),
                            0 > r && (r += 2 * Math.PI),
        ...
        A.prototype.createLabels = function() {
            ...
            if ("axisX" !== this.type || "dateTime" !== this.valueType || this.logarithmic) {
                ...
                if (this.logarithmic && !this.equidistantInterval)
                    ...
                    g = q; b < this.logLabelValues.length; b++)
                        ...
                        c < this.viewportMinimum)
                            ...
                            }) : "axisX" === this.type && this.labels[m] ? this.labels[m] : ha(m, this.valueFormatString, this.chart._cultureInfo),
                            a = new ka(this.ctx,{
                                x: 0,
                                y: 0,
                                maxWidth: f,
                ...
                g = q,
                c = this.intervalStartPosition; c < e; Wa(c, b, this.intervalType)) {
            ...
            if ("bottom" === this._position || "top" === this._position)
                h = this.logarithmic && !this.equidistantInterval && 2 <= this._labels.length ? this.lineCoordinates.width * Math.log(Math.min(this._labels[this._labels.length - 1].position / this._labels[this._labels.length - 2].position, this._labels[1].position / this._labels[0].position)) / Math.log(this.range) : this.lineCoordinates.width / (this.logarithmic && this.equidistantInterval ? Math.log(this.range) / Math.log(this.logarithmBase) : Math.abs(this.range)) * K[this.intervalType + "Duration"] * this.interval,
                ...
                h = this.logarithmic && !this.equidistantInterval && 2 <= this._labels.length ? this.lineCoordinates.height * Math.log(Math.min(this._labels[this._labels.length - 1].position / this._labels[this._labels.length - 2].position, this._labels[1].position / this._labels[0].position)) / Math.log(this.range) : this.lineCoordinates.height / (this.logarithmic && this.equidistantInterval ? Math.log(this.range) / Math.log(this.logarithmBase) : Math.abs(this.range)) * K[this.intervalType + "Duration"] * this.interval,
            ...
            if (this.labelAutoFit || this.options.labelAutoFit)
                if (r(this.labelAngle) || (this.labelAngle = (this.labelAngle % 360 + 360) % 360,
                90 < this.labelAngle && 270 > this.labelAngle ? this.labelAngle -= 180 : 270 <= this.labelAngle && 360 >= this.labelAngle && (this.labelAngle -= 360)),
                "bottom" === this._position || "top" === this._position)
                            ...
                            if (!this._labels[c].breaksLabelType) {
                                ...
                                if (r(this.options.labelAngle) && isNaN(this.options.labelAngle) && 0 !== this.options.labelAngle)
                                    ...
                                    !r(this.options.labelWrap))
                                        this.labelWrap ? r(this.options.labelMaxWidth) ? (this.sessionVariables.labelMaxWidth = Math.min(Math.max(f, q), m),
                                        this.sessionVariables.labelWrap = this.labelWrap,
                                        d && t.width + d.width >> 0 > 2 * f && (this.sessionVariables.labelAngle = -25)) : (this.sessionVariables.labelWrap = this.labelWrap,
                                        this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth,
                                        this.sessionVariables.labelAngle = this.sessionVariables.labelMaxWidth > f ? -25 : this.sessionVariables.labelAngle) : r(this.options.labelMaxWidth) ? (this.sessionVariables.labelWrap = this.labelWrap,
                                        this.sessionVariables.labelMaxHeight = l,
                                        this.sessionVariables.labelMaxWidth = f,
                                        d && t.width + d.width >> 0 > 2 * f && (this.sessionVariables.labelAngle = -25,
                                        this.sessionVariables.labelMaxWidth = m)) : (this.sessionVariables.labelAngle = this.sessionVariables.labelMaxWidth > f ? -25 : this.sessionVariables.labelAngle,
                                        this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth,
                                        this.sessionVariables.labelMaxHeight = l,
                                        this.sessionVariables.labelWrap = this.labelWrap);
                                    else {
                                        if (r(this.options.labelWrap))
                                            if (!r(this.options.labelMaxWidth))
                                                ...
                                                if (b = t.width + d.width >> 0,
                                                g = this.labelFontSize,
                                                q < f)
                                                    b - 2 * f > p && (p = b - 2 * f,
                                                    b >= 2 * f && b < 2.2 * f ? (this.sessionVariables.labelMaxWidth = f,
                                                    r(this.options.labelFontSize) && 12 < g && (g = Math.floor(12 / 13 * g),
                                                    a.measureText()),
                                                    ...
                                                    r(this.options.labelFontSize) && 12 < this.labelFontSize && (this.labelFontSize = Math.floor(12 / 13 * this.labelFontSize),
                                                    a.measureText()),
                                                    this.sessionVariables.labelFontSize = r(this.options.labelFontSize) ? g : this.options.labelFontSize,
                                                    this.sessionVariables.labelAngle = this.labelAngle) : b >= 3.2 * f && b < 3.6 * f ? (this.sessionVariables.labelAngle = -25,
                                                    this.sessionVariables.labelWrap = !0,
                                                    this.sessionVariables.labelMaxWidth = m,
                                                    this.sessionVariables.labelFontSize = this.labelFontSize) : b > 3.6 * f && b < 5 * f ? (r(this.options.labelFontSize) && 12 < g && (g = Math.floor(12 / 13 * g),
                                                    a.measureText()),
                                                    this.sessionVariables.labelFontSize = r(this.options.labelFontSize) ? g : this.options.labelFontSize,
                                                    this.sessionVariables.labelWrap = !0,
                                                    this.sessionVariables.labelAngle = -25,
                                                    this.sessionVariables.labelMaxWidth = m) : b > 5 * f && (this.sessionVariables.labelWrap = !0,
                                                    this.sessionVariables.labelMaxWidth = f,
                                                    ...
                                                    for (this.sessionVariables.labelFontSize = r(this.options.labelFontSize) ? g : this.options.labelFontSize,
                                                    this.sessionVariables.labelWrap = !0,
                                    ...
                                    r(this.options.labelWrap)) ? r(this.options.labelWrap) && (this.labelWrap && !r(this.options.labelMaxWidth) ? (this.sessionVariables.labelWrap = this.labelWrap,
                                    ...
                                    this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth ? this.options.labelMaxWidth : m) : (r(this.options.labelMaxWidth),
                                    this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth ? this.options.labelMaxWidth : m,
                                    this.sessionVariables.labelWrap = this.labelWrap),
                                    this.sessionVariables.labelMaxHeight = l)
                            }
                    ...
                    if (f = r(this.options.labelMaxWidth) ? 0.3 * this.chart.width >> 0 : this.options.labelMaxWidth,
                    l = "undefined" === typeof this.options.labelWrap || this.labelWrap ? 0.3 * this.chart.height >> 0 : 1.5 * this.labelFontSize,
                    !this.chart.panEnabled && 1 <= this._labels.length) {
                        this.sessionVariables.labelFontSize = this.labelFontSize;
                        this.sessionVariables.labelMaxWidth = f;
                        ...
                        for (c = 0; c < this._labels.length; c++)
                            if (!this._labels[c].breaksLabelType) {
                                ...
                                Math.cos(Math.PI / 180 * Math.abs(this.labelAngle));
                                Math.sin(Math.PI / 180 * Math.abs(this.labelAngle));
                                r(this.options.labelAngle) && isNaN(this.options.labelAngle) && 0 !== this.options.labelAngle ? r(this.options.labelWrap) ? r(this.options.labelWrap) && (r(this.options.labelMaxWidth) ? r(d) || (h = t.height + d.height >> 0,
                                h - 2 * l > q && (q = h - 2 * l,
                                h >= 2 * l && h < 2.4 * l ? (r(this.options.labelFontSize) && 12 < this.labelFontSize && (this.labelFontSize = Math.floor(12 / 13 * this.labelFontSize),
                                a.measureText()),
                                this.sessionVariables.labelMaxHeight = l,
                                this.sessionVariables.labelFontSize = r(this.options.labelFontSize) ? this.labelFontSize : this.options.labelFontSize) : h >= 2.4 * l && h < 2.8 * l ? (this.sessionVariables.labelMaxHeight = b,
                                this.sessionVariables.labelFontSize = this.labelFontSize,
                                this.sessionVariables.labelWrap = !0) : h >= 2.8 * l && h < 3.2 * l ? (this.sessionVariables.labelMaxHeight = l,
                                this.sessionVariables.labelWrap = !0,
                                r(this.options.labelFontSize) && 12 < this.labelFontSize && (this.labelFontSize = Math.floor(12 / 13 * this.labelFontSize),
                                a.measureText()),
                                this.sessionVariables.labelFontSize = r(this.options.labelFontSize) ? this.labelFontSize : this.options.labelFontSize,
                                this.sessionVariables.labelAngle = r(this.sessionVariables.labelAngle) ? 0 : this.sessionVariables.labelAngle) : h >= 3.2 * l && h < 3.6 * l ? (this.sessionVariables.labelMaxHeight = b,
                                this.sessionVariables.labelWrap = !0,
                                this.sessionVariables.labelFontSize = this.labelFontSize) : h > 3.6 * l && h < 10 * l ? (r(this.options.labelFontSize) && 12 < this.labelFontSize && (this.labelFontSize = Math.floor(12 / 13 * this.labelFontSize),
                                a.measureText()),
                                this.sessionVariables.labelFontSize = r(this.options.labelFontSize) ? this.labelFontSize : this.options.labelFontSize,
                                this.sessionVariables.labelMaxWidth = f,
                                this.sessionVariables.labelMaxHeight = l,
                                this.sessionVariables.labelAngle = r(this.sessionVariables.labelAngle) ? 0 : this.sessionVariables.labelAngle) : h > 10 * l && h < 50 * l && (r(this.options.labelFontSize) && 12 < this.labelFontSize && (this.labelFontSize = Math.floor(12 / 13 * this.labelFontSize),
                                a.measureText()),
                                this.sessionVariables.labelFontSize = r(this.options.labelFontSize) ? this.labelFontSize : this.options.labelFontSize,
                                this.sessionVariables.labelMaxHeight = l,
                                this.sessionVariables.labelMaxWidth = f,
                                this.sessionVariables.labelAngle = r(this.sessionVariables.labelAngle) ? 0 : this.sessionVariables.labelAngle))) : (this.sessionVariables.labelMaxHeight = l,
                                ...
                                r(this.options.labelWrap)) ? r(this.options.labelWrap) && (this.labelWrap && !r(this.options.labelMaxWidth) ? (this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth ? this.options.labelMaxWidth : this.sessionVariables.labelMaxWidth,
                                this.sessionVariables.labelWrap = this.labelWrap,
                                ...
                                r(this.options.labelMaxWidth) && (this.sessionVariables.labelAngle = this.labelAngle))) : this.options.labelWrap ? (this.sessionVariables.labelMaxHeight = 0 === this.labelAngle ? l : b,
                                this.sessionVariables.labelWrap = this.labelWrap,
            ...
            for (c = 0; c < this.stripLines.length; c++) {
                ...
                if ("outside" === f.labelPlacement) {
                    ...
                    if ("bottom" === this._position || "top" === this._position)
                        r(f.options.labelWrap) && !r(this.sessionVariables.stripLineLabelMaxHeight) ? A = this.sessionVariables.stripLineLabelMaxHeight : this.sessionVariables.stripLineLabelMaxHeight = A = f.labelWrap ? 0.8 * this.chart.height >> 0 : 1.5 * this.labelFontSize;
                    ...
                    A = r(f.options.labelWrap) || f.labelWrap ? "bottom" === this._position || "top" === this._position ? 0.8 * this.chart.width >> 0 : 0.8 * this.chart.height >> 0 : 1.5 * this.labelFontSize,
        ...
        A.setLayout = function(a, d, c, b, e, f) {
            ...
            for (g = 0; g < q.length; g++)
                if (q[g] && q[g].scaleBreaks && q[g].scaleBreaks._appliedBreaks.length)
                    for (var t = q[g].scaleBreaks._appliedBreaks, w = 0; w < t.length && !(t[w].startValue > q[g].viewportMaximum); w++)
                        t[w].endValue < q[g].viewportMinimum || (r(q[g].scaleBreaks.firstBreakIndex) && (q[g].scaleBreaks.firstBreakIndex = w),
                        t[w].startValue >= q[g].viewPortMinimum && (q[g].scaleBreaks.lastBreakIndex = w));
            ...
            if ("normal" === e) {
                for (var y = [], x = [], z = [], A = [], N = [], Q = [], O = [], P = []; 4 > w; ) {
                    ...
                    if (c && 0 < c.length)
                        for (z = [],
                        g = R = 0; g < c.length; g++)
                            z.push(Math.ceil(c[g] ? c[g].createLabelsAndCalculateWidth() : 0)),
                            R += z[g],
                    ...
                    if (b && 0 < b.length)
                        for (A = [],
                        g = aa = 0; g < b.length; g++)
                            A.push(Math.ceil(b[g] ? b[g].createLabelsAndCalculateWidth() : 0)),
                            aa += A[g],
                            $ += b[g] ? b[g].margin : 0;
                    else
                    ...
                    if (a && 0 < a.length)
                        for (g = 0; g < a.length; g++)
                            ...
                            !a[g] || (!a[g].labelAutoFit || r(C) || r(B) || m.isNavigator || m.stockChart) || (h = 0,
                            0 < a[g].labelAngle ? B + u > n && (h += 0 < a[g].labelAngle ? B + u - n - aa : 0) : 0 > a[g].labelAngle ? C - v < l && C - v < a[g].viewportMinimum && (E = l - (L + a[g].tickLength + z + C - v + a[g].labelFontSize / 2)) : 0 === a[g].labelAngle && (B + u > n && (h = B + u / 2 - n - aa),
                            C - v < l && C - v < a[g].viewportMinimum && (E = l - L - a[g].tickLength - z - C + v / 2)),
                            a[g].viewportMaximum === a[g].maximum && a[g].viewportMinimum === a[g].minimum && 0 < a[g].labelAngle && 0 < h ? n -= h : a[g].viewportMaximum === a[g].maximum && a[g].viewportMinimum === a[g].minimum && 0 > a[g].labelAngle && 0 < E ? l += E : a[g].viewportMaximum === a[g].maximum && a[g].viewportMinimum === a[g].minimum && 0 === a[g].labelAngle && (0 < E && (l += E),
                            0 < h && (n -= h))),
                            m.panEnabled ? U = r(m.sessionVariables.axisX.height) ? m.sessionVariables.axisX.height = U : m.sessionVariables.axisX.height : m.sessionVariables.axisX.height = U,
                            ...
                            "inside" === a[g].labelPlacement && 0 < g && (a[g].lineCoordinates.y1 = a[g].lineCoordinates.y1 + y[g] - (a[g]._titleTextBlock ? a[g]._titleTextBlock.height : 0) - ("inside" === a[g].tickPlacement ? a[g].tickLength : 0),
                    ...
                    if (d && 0 < d.length)
                        for (g = 0; g < d.length; g++)
                            ...
                            d[g].lineCoordinates.x2 = Math.round(f.x2 - aa - $ > m.width - p ? m.width - p : f.x2 - aa - $),
                            d[g].lineCoordinates.width = Math.abs(n - l),
                            ...
                            v = k.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(k.textBlock.angle)) + (k.textBlock.height - h.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(k.textBlock.angle)),
                            u = h.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(h.textBlock.angle)) + (h.textBlock.height - h.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(h.textBlock.angle))),
                            m.panEnabled ? Y = r(m.sessionVariables.axisX2.height) ? m.sessionVariables.axisX2.height = Y : m.sessionVariables.axisX2.height : m.sessionVariables.axisX2.height = Y,
                            h = Math.round(f.y1),
                    ...
                    if (c && 0 < c.length)
                        for (g = 0; g < c.length; g++)
                            ...
                            h = Math.round(f.y1 + Y + X < Math.max(L, p) ? Math.max(L, p) : f.y1 + Y + X),
                            ...
                            "inside" === c[g].labelPlacement && 0 < g && (c[g].lineCoordinates.x1 = c[g].lineCoordinates.x1 - (z[g] - (c[g]._titleTextBlock ? c[g]._titleTextBlock.height : 0)) + ("outside" === c[g].tickPlacement ? c[g].tickLength : 0),
                    ...
                    if (b && 0 < b.length)
                        for (g = 0; g < b.length; g++)
                            b[g] && (l = Math.round(a[0] ? a[0].lineCoordinates.x2 : d[0].lineCoordinates.x2),
                            n = Math.round(l),
                            ...
                            "inside" === b[g].labelPlacement && 0 < g && (b[g].lineCoordinates.x1 = b[g].lineCoordinates.x1 + (A[g] - (b[g]._titleTextBlock ? b[g]._titleTextBlock.height : 0)) - ("outside" === b[g].tickPlacement ? b[g].tickLength : 0) - 2,
                    ...
                    if (a && 0 < a.length)
                        for (g = 0; g < a.length; g++)
                            ...
                            B = a[g].logarithmic ? (1 < l ? Math.log(l) / a[g].conversionParameters.lnLogarithmBase * Math.abs(a[g].conversionParameters.pixelPerUnit) : 0) + a[g].lineCoordinates.x1 : (0 < l ? l * Math.abs(a[g].conversionParameters.pixelPerUnit) : 0) + a[g].lineCoordinates.x1));
                    if (d && 0 < d.length)
                        for (g = 0; g < d.length; g++)
                            ...
                            B = d[g].logarithmic ? (1 < l ? Math.log(l) / d[g].conversionParameters.lnLogarithmBase * Math.abs(d[g].conversionParameters.pixelPerUnit) : 0) + d[g].lineCoordinates.x1 : (0 < l ? l * Math.abs(d[g].conversionParameters.pixelPerUnit) : 0) + d[g].lineCoordinates.x1);
                    for (g = 0; g < q.length; g++)
                ...
                for (Q = []; 4 > w; ) {
                    ...
                    if (c && 0 < c.length)
                        for (g = 0; g < c.length; g++)
                            ...
                            n = Math.round(f.x2 - U - X > m.width - 10 ? m.width - 10 : f.x2 - U - X),
                            c[g].labelAutoFit && !r(y) && (0 < !a.length && (l = 0 > c[g].labelAngle ? Math.max(l, y) : 0 === c[g].labelAngle ? Math.max(l, y / 2) : l),
                    ...
                    if (b && 0 < b.length)
                        for (g = 0; g < b.length; g++)
                            b[g].lineCoordinates = {},
                            l = Math.round(f.x1 + V + e),
                            n = Math.round(f.x2 - U - X > b[g].chart.width - 10 ? b[g].chart.width - 10 : f.x2 - U - X),
                            b[g] && b[g].labelAutoFit && !r(z) && (0 < !a.length && (l = 0 < b[g].labelAngle ? Math.max(l, z) : 0 === b[g].labelAngle ? Math.max(l, z / 2) : l),
                            0 < !d.length && (n -= A / 2)),
                    ...
                    if (b && 0 < b.length)
                        for (g = b.length - 1; 0 <= g; g--)
                            ...
                            "inside" === b[g].labelPlacement && 0 < g && (b[g].lineCoordinates.y1 = k - C[g] + (b[g]._titleTextBlock ? b[g]._titleTextBlock.height : 0)),
                            b[g].bounds = {
                                x1: l,
                                y1: h + (b[g].margin + F),
                                x2: n,
                        ...
                        for (g = 0; g < a.length; g++) {
                            ...
                            if (c && 0 < c.length)
                                for (L = 0; L < c.length; L++)
                                    c[L] && c[L].labelAutoFit && (n = 0 > c[L].labelAngle ? Math.max(n, y) : 0 === c[L].labelAngle ? Math.max(n, y / 2) : n,
                                    l = 0 > c[L].labelAngle || 0 === c[L].labelAngle ? n - V : l);
                            if (b && 0 < b.length)
                                for (L = 0; L < b.length; L++)
                                    b[L] && b[L].labelAutoFit && (n = b[L].lineCoordinates.x1,
                                    l = n - V);
                            a[g].lineCoordinates = {
                                x1: n - O,
                                y1: h,
                    ...
                    if (d && 0 < d.length)
                        for (g = 0; g < d.length; g++) {
                            ...
                            if (c && 0 < c.length)
                                for (L = 0; L < c.length; L++)
                                    c[L] && c[L].labelAutoFit && (n = 0 > c[L].labelAngle ? Math.max(n, y) : 0 === c[L].labelAngle ? Math.max(n, y / 2) : n,
                                    l = 0 > c[L].labelAngle || 0 === c[L].labelAngle ? n - U : l);
                            if (b && 0 < b.length)
                                for (L = 0; L < b.length; L++)
                                    b[L] && b[L].labelAutoFit && (n = b[L].lineCoordinates.x2,
                                    l = n - U);
                            d[g].lineCoordinates = {
                                x1: n + P,
                                y1: h,
        ...
        A.prototype.calculateBreaksInPixels = function() {
            if (!(this.scaleBreaks && 0 >= this.scaleBreaks._appliedBreaks.length)) {
                ...
                for (var d = 0; d < a.length && !(a[d].startValue > this.conversionParameters.maximum); d++)
                    a[d].endValue < this.conversionParameters.minimum || (r(this.scaleBreaks.firstBreakIndex) && (this.scaleBreaks.firstBreakIndex = d),
                    ...
                    if (this.logarithmic && !this.equidistantInterval && this.labelAutoFit) {
                        for (var c = [], e = 0 !== this.labelAngle && 360 !== this.labelAngle ? 1 : 1.2, l, h = this.viewportMaximum, n = this.lineCoordinates.width / Math.log(this.range), k = this._labels.length - 1; 0 <= k; k--) {
                            ...
                            if (p.position < this.viewportMinimum)
                                break;
                            p.position > this.viewportMaximum || !(k === this._labels.length - 1 || l < Math.log(h / p.position) * n / e) || (c.push(p),
                            h = p.position,
                            l = p.textBlock.width * Math.abs(Math.cos(Math.PI / 180 * this.labelAngle)) + p.textBlock.height * Math.abs(Math.sin(Math.PI / 180 * this.labelAngle)))
                        }
                        this._labels = c
                    } else {
                        for (k = 0; k < this._labels.length; k++)
                            p = this._labels[k],
                            p.position < this.viewportMinimum || (l = p.textBlock.width * Math.abs(Math.cos(Math.PI / 180 * this.labelAngle)) + p.textBlock.height * Math.abs(Math.sin(Math.PI / 180 * this.labelAngle)),
                            c += l);
                ...
                if ("left" === this._position || "right" === this._position)
                    if (this.logarithmic && !this.equidistantInterval && this.labelAutoFit) {
                        for (var c = [], m, h = this.viewportMaximum, n = this.lineCoordinates.height / Math.log(this.range), k = this._labels.length - 1; 0 <= k; k--) {
                            ...
                            if (p.position < this.viewportMinimum)
                                break;
                            p.position > this.viewportMaximum || !(k === this._labels.length - 1 || m < Math.log(h / p.position) * n) || (c.push(p),
                            h = p.position,
                            m = p.textBlock.height * Math.abs(Math.cos(Math.PI / 180 * this.labelAngle)) + p.textBlock.width * Math.abs(Math.sin(Math.PI / 180 * this.labelAngle)))
                        }
                        this._labels = c
                    } else {
                        for (k = 0; k < this._labels.length; k++)
                            p = this._labels[k],
                            p.position < this.viewportMinimum || (m = p.textBlock.height * Math.abs(Math.cos(Math.PI / 180 * this.labelAngle)) + p.textBlock.width * Math.abs(Math.sin(Math.PI / 180 * this.labelAngle)),
                            b += m);
                    ...
                    !(c.position < this.viewportMinimum || c.position > this.viewportMaximum || isNaN(this.range))) {
                        ...
                        if ("outside" === c.stripLine.labelPlacement)
                            ...
                            "bottom" === this._position) {
                                ...
                                "top" === this._position ? (m = 1 === this.ctx.lineWidth % 2 ? (a.x << 0) + 0.5 : a.x << 0,
                                this.ctx.beginPath(),
                                this.ctx.moveTo(m, a.y << 0),
                                this.ctx.lineTo(m, a.y - this.tickLength << 0),
                                this.ctx.stroke(),
                                ...
                                a.y -= this.tickLength + (c.textBlock.height * Math.cos(Math.PI / 180 * this.labelAngle) + (0 < this.labelAngle ? c.textBlock.width * Math.sin(Math.PI / 180 * this.labelAngle) : 0)))) : "left" === this._position ? (m = 1 === this.ctx.lineWidth % 2 ? (a.y << 0) + 0.5 : a.y << 0,
                                this.ctx.beginPath(),
                            ...
                            a.x - c.textBlock.height > this.chart.plotArea.x1 ? r(k.startValue) ? a.x -= c.textBlock.height - c.textBlock.fontSize / 2 : a.x -= c.textBlock.height / 2 - c.textBlock.fontSize / 2 + 3 : (c.textBlock.angle = 90,
                            r(k.startValue) ? a.x += c.textBlock.height - c.textBlock.fontSize / 2 : a.x += c.textBlock.height / 2 - c.textBlock.fontSize / 2 + 3),
                            ...
                            c.textBlock.angle = 0,
                            c.textBlock.measureText(),
                            a.y - c.textBlock.height > this.chart.plotArea.y1 ? r(k.startValue) ? a.y -= c.textBlock.height - c.textBlock.fontSize / 2 : a.y -= c.textBlock.height / 2 - c.textBlock.fontSize + 3 : a.y - c.textBlock.height < this.chart.plotArea.y2 ? a.y += c.textBlock.fontSize / 2 + 3 : r(k.startValue) ? a.y -= c.textBlock.height - c.textBlock.fontSize / 2 : a.y -= c.textBlock.height / 2 - c.textBlock.fontSize + 3,
                            ...
                            c.textBlock.angle = 0,
                            c.textBlock.measureText(),
                            a.y - +c.textBlock.height > this.chart.plotArea.y1 ? r(k.startValue) ? a.y -= c.textBlock.height - c.textBlock.fontSize / 2 : a.y -= c.textBlock.height / 2 - c.textBlock.fontSize / 2 - 3 : a.y - c.textBlock.height < this.chart.plotArea.y2 ? a.y += c.textBlock.fontSize / 2 + 3 : r(k.startValue) ? a.y -= c.textBlock.height - c.textBlock.fontSize / 2 : a.y -= c.textBlock.height / 2 - c.textBlock.fontSize / 2 + 3,
        ...
        A.prototype.createMask = function() {
            if (this.scaleBreaks && 0 < this.scaleBreaks._appliedBreaks.length) {
                ...
                w ? (this.maskCanvas = va(this.chart.width, this.chart.height),
        ...
        A.prototype.calculateAxisParameters = function() {
            if (this.logarithmic)
                ...
                if ("axisX" === this.type) {
                    ...
                    f += b,
                    e -= b);
                    Infinity !== this.dataInfo.minDiff ? l = this.dataInfo.minDiff : 1 < f - e ? l = 0.5 * Math.abs(f - e) : (l = 1,
                    c && (d = !0))
                } else
                ...
                if ("axisX" === this.type && c) {
                    ...
                    this.intervalType = "millisecond") : b / (1 * K.secondDuration) <= a ? (this.interval = 1,
                    this.intervalType = "second") : b / (2 * K.secondDuration) <= a ? (this.interval = 2,
                    this.intervalType = "second") : b / (5 * K.secondDuration) <= a ? (this.interval = 5,
                    this.intervalType = "second") : b / (10 * K.secondDuration) <= a ? (this.interval = 10,
                    this.intervalType = "second") : b / (15 * K.secondDuration) <= a ? (this.interval = 15,
                    this.intervalType = "second") : b / (20 * K.secondDuration) <= a ? (this.interval = 20,
                    this.intervalType = "second") : b / (30 * K.secondDuration) <= a ? (this.interval = 30,
                    this.intervalType = "second") : b / (1 * K.minuteDuration) <= a ? (this.interval = 1,
                    this.intervalType = "minute") : b / (2 * K.minuteDuration) <= a ? (this.interval = 2,
                    this.intervalType = "minute") : b / (5 * K.minuteDuration) <= a ? (this.interval = 5,
                    this.intervalType = "minute") : b / (10 * K.minuteDuration) <= a ? (this.interval = 10,
                    this.intervalType = "minute") : b / (15 * K.minuteDuration) <= a ? (this.interval = 15,
                    this.intervalType = "minute") : b / (20 * K.minuteDuration) <= a ? (this.interval = 20,
                    this.intervalType = "minute") : b / (30 * K.minuteDuration) <= a ? (this.interval = 30,
                    this.intervalType = "minute") : b / (1 * K.hourDuration) <= a ? (this.interval = 1,
                    this.intervalType = "hour") : b / (2 * K.hourDuration) <= a ? (this.interval = 2,
                    this.intervalType = "hour") : b / (3 * K.hourDuration) <= a ? (this.interval = 3,
                    this.intervalType = "hour") : b / (6 * K.hourDuration) <= a ? (this.interval = 6,
                    this.intervalType = "hour") : b / (1 * K.dayDuration) <= a ? (this.interval = 1,
                    this.intervalType = "day") : b / (2 * K.dayDuration) <= a ? (this.interval = 2,
                    this.intervalType = "day") : b / (4 * K.dayDuration) <= a ? (this.interval = 4,
                    this.intervalType = "day") : b / (1 * K.weekDuration) <= a ? (this.interval = 1,
                    this.intervalType = "week") : b / (2 * K.weekDuration) <= a ? (this.interval = 2,
                    this.intervalType = "week") : b / (3 * K.weekDuration) <= a ? (this.interval = 3,
                    this.intervalType = "week") : b / (1 * K.monthDuration) <= a ? (this.interval = 1,
                    this.intervalType = "month") : b / (2 * K.monthDuration) <= a ? (this.interval = 2,
                    this.intervalType = "month") : b / (3 * K.monthDuration) <= a ? (this.interval = 3,
                    this.intervalType = "month") : b / (6 * K.monthDuration) <= a ? (this.interval = 6,
                    this.intervalType = "month") : (this.interval = b / (1 * K.yearDuration) <= a ? 1 : b / (2 * K.yearDuration) <= a ? 2 : b / (4 * K.yearDuration) <= a ? 4 : Math.floor(A.getNiceNumber(b / (a - 1), !0) / K.yearDuration),
                ...
                if (null === this.minimum || null === this.maximum)
                    ...
                    f += b,
                    e -= b),
                    l = Infinity !== this.dataInfo.minDiff ? this.dataInfo.minDiff : 1 < f - e ? 0.5 * Math.abs(f - e) : 1) : "axisY" === this.type && (e = null !== this.minimum ? this.minimum : this.dataInfo.min,
                    f = null !== this.maximum ? this.maximum : this.dataInfo.max,
        ...
        A.prototype.calculateLogarithmicAxisParameters = function() {
            ...
            1 === e / b && (l = Math.pow(this.logarithmBase, "undefined" === typeof this.options.interval ? 0.4 : this.options.interval),
            e *= l,
            b /= l),
            ...
            b = 1) : 1 === e / b ? (l = Math.min(e * Math.pow(this.logarithmBase, 0.01), Math.pow(this.logarithmBase, 5)),
            e *= l,
            b /= l) : b > e ? (l = Math.min(b / e * Math.pow(this.logarithmBase, 0.01), Math.pow(this.logarithmBase, 5)),
            1 <= e ? b = e / l : e = b * l) : (l = Math.min(e / b * Math.pow(this.logarithmBase, 0.01), Math.pow(this.logarithmBase, 0.04)),
            1 !== e && (e *= l),
            1 !== b && (b /= l)),
            ...
            this.options && 0 < this.options.interval ? this.interval = this.options.interval : (this.interval = A.getNiceExponent(Math.log(l) / d / (a - 1), !0),
            ...
            this.options && "undefined" === typeof this.options.interval && (this.interval = A.getNiceExponent(Math.ceil(Math.log(l) / d) / (a - 1)),
            c = A.getNiceNumber((this.viewportMaximum - this.viewportMinimum) / (a - 1), !0)));
            if (null === this.minimum || null === this.maximum)
                ...
                b /= this.logarithmBase) : 1 === e / b ? (l = Math.pow(this.logarithmBase, this.interval),
                e *= l,
                b /= l) : b > e ? (l = Math.min(0.01 * (b / e), 5),
                1 <= e ? b = e / l : e = b * l) : (l = Math.min(e / b * Math.pow(this.logarithmBase, 0.01), Math.pow(this.logarithmBase, 0.04)),
                1 !== e && (e *= l),
                1 !== b && (b /= l)) : (e = "undefined" === typeof this.options.interval ? 0 : this.options.interval,
                b = 1),
                f = Infinity !== this.dataInfo.minDiff ? this.dataInfo.minDiff : e / b > this.logarithmBase ? e / b * Math.pow(this.logarithmBase, 0.5) : this.logarithmBase,
                ...
                r(null === this.sessionVariables.viewportMaximum || isNaN(this.sessionVariables.viewportMaximum) ? "undefined" === typeof this.sessionVariables.newViewportMaximum ? 0 : this.sessionVariables.newViewportMaximum : this.sessionVariables.viewportMaximum) || (this.maximum = Math.max(this.maximum, null === this.sessionVariables.viewportMaximum || isNaN(this.sessionVariables.viewportMaximum) ? "undefined" === typeof this.sessionVariables.newViewportMaximum ? 0 : this.sessionVariables.newViewportMaximum : this.sessionVariables.viewportMaximum))),
        ...
        ga.prototype.render = function(a) {
            if (0 !== this.spacing || 0 !== this.options.lineThickness && ("undefined" !== typeof this.options.lineThickness || 0 !== this.parent.lineThickness)) {
                ...
                if ("bottom" === this.scaleBreaks.parent._position || "top" === this.scaleBreaks.parent._position)
                    ...
                    h = this.chart.plotArea.y2 + p / 2 + 0.5 << 0) : (e = this.chart.plotArea.y2,
                    ...
                    "straight" === this.type || "top" === this.scaleBreaks.parent._position && 0 >= a || "bottom" === this.scaleBreaks.parent._position && 0 <= a)
                        ...
                        m = (h - k) / a / 3;
                        for (var q = 0; q < m; q++)
                            this.ctx.bezierCurveTo(n + f * a, k + a, n + f * a, k + 2 * a, n, k + 3 * a),
                            k += 3 * a,
                            f *= -1;
                        this.ctx.bezierCurveTo(n + f * a, k + a, n + f * a, k + 2 * a, n, k + 3 * a);
                        n = l;
                    ...
                    l = this.chart.plotArea.x2 + p / 2 + 0.5 << 0) : (b = this.chart.plotArea.x2,
        ...
        ba.prototype.showAt = function(a) {
            ...
            for (b = 0; b < d.axisX.length; b++)
                ...
                d.axisX[b].crosshair && (d.axisX[b].crosshair.enabled && !r(a) && a >= d.axisX[b].viewportMinimum && a <= d.axisX[b].viewportMaximum) && (d.axisX[b].showCrosshair(a),
                d.axisX[b].crosshair._updatedValue = a,
                this === d.axisX[b].crosshair && (c = !0));
            for (b = 0; b < d.axisX2.length; b++)
                a = d.axisX2[b]._crosshairValue,
                d.axisX2[b].crosshair && (d.axisX2[b].crosshair.enabled && !r(a) && a >= d.axisX2[b].viewportMinimum && a <= d.axisX2[b].viewportMaximum) && (d.axisX2[b].showCrosshair(a),
                d.axisX2[b].crosshair._updatedValue = a,
                this === d.axisX2[b].crosshair && (c = !0));
            for (b = 0; b < d.axisY.length; b++)
                a = d.axisY[b]._crosshairValue,
                d.axisY[b].crosshair && (d.axisY[b].crosshair.enabled && !r(a) && a >= d.axisY[b].viewportMinimum && a <= d.axisY[b].viewportMaximum) && (d.axisY[b].showCrosshair(a),
                d.axisY[b].crosshair._updatedValue = a,
                this === d.axisY[b].crosshair && (c = !0));
            for (b = 0; b < d.axisY2.length; b++)
                a = d.axisY2[b]._crosshairValue,
                d.axisY2[b].crosshair && (d.axisY2[b].crosshair.enabled && !r(a) && a >= d.axisY2[b].viewportMinimum && a <= d.axisY2[b].viewportMaximum) && (d.axisY2[b].showCrosshair(a),
            ...
            if (this.snapToDataPoint) {
                ...
                if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
                    ...
                    for (var B = 0; B < this.parent.dataSeries.length; B++)
                        (v = this.parent.dataSeries[B].getDataPointAtX(t, !0)) && 0 <= v.index && (v.dataSeries = this.parent.dataSeries[B],
                    ...
                    if ("rangeBar" === m[0].dataSeries.type || "error" === m[0].dataSeries.type)
                        for (var v = Math.abs(a - this.parent.convertValueToPixel(m[B].dataPoint.y[0])), u = 0, t = 0; t < m.length; t++)
                            if (m[t].dataPoint.y && m[t].dataPoint.y.length)
                                for (var y = 0; y < m[t].dataPoint.y.length; y++)
                                    u = Math.abs(a - this.parent.convertValueToPixel(m[t].dataPoint.y[y])),
                                    u < v && (v = u,
                                    B = t);
                            else
                                u = Math.abs(a - this.parent.convertValueToPixel(m[t].dataPoint.y)),
                                u < v && (v = u,
                                B = t);
                        ...
                        for (var v = Math.abs(a - this.parent.convertValueToPixel(m[0].dataPoint.y)), z = x = u = 0, t = 0; t < m.length; t++)
                            if (m[t].dataPoint.y && m[t].dataPoint.y.length)
                                for (y = 0; y < m[t].dataPoint.y.length; y++)
                                    u = Math.abs(a - this.parent.convertValueToPixel(m[t].dataPoint.y[y])),
                                    u < v && (v = u,
                                ...
                                x += m[t].dataPoint.y,
                                z = m[t].dataPoint.x.getTime ? m[t].dataPoint.x.getTime() : m[t].dataPoint.x,
                    ...
                    if ("bottom" === this.parent._position || "top" === this.parent._position) {
                        ...
                        if ("rangeBar" === this.parent.dataSeries[B].type || "error" === this.parent.dataSeries[B].type) {
                            ...
                            }) : r(this.options.label) ? ha(r(c) ? y.dataPoint.y[b] : c, this.valueFormatString, this.chart._cultureInfo) : this.label
                            ...
                            n = 1 === q.lineWidth % 2 ? (this.parent.convertValueToPixel(y.dataPoint.y) << 0) + 0.5 : this.parent.convertValueToPixel(y.dataPoint.y) << 0,
                        ...
                        if (z) {
                            if ("axisX" === this.parent.type)
                                ...
                                v = null,
                                B = 0; B < this.parent.dataSeries.length; B++)
                    ...
                    if ("rangeColumn" === m[0].dataSeries.type || "rangeArea" === m[0].dataSeries.type || "error" === m[0].dataSeries.type || "rangeSplineArea" === m[0].dataSeries.type || "candlestick" === m[0].dataSeries.type || "ohlc" === m[0].dataSeries.type || "boxAndWhisker" === m[0].dataSeries.type)
                        ...
                        t = u = 0; t < m.length; t++)
                            if (m[t].dataPoint.y && m[t].dataPoint.y.length)
                                for (y = 0; y < m[t].dataPoint.y.length; y++)
                                    u = Math.abs(d - this.parent.convertValueToPixel(m[t].dataPoint.y[y])),
                                    u < v && (v = u,
                                    B = t);
                            else
                                u = Math.abs(d - this.parent.convertValueToPixel(m[t].dataPoint.y)),
                                u < v && (v = u,
                                B = t);
                    ...
                    if ("rangeColumn" === this.parent.dataSeries[B].type || "rangeArea" === this.parent.dataSeries[B].type || "error" === this.parent.dataSeries[B].type || "rangeSplineArea" === this.parent.dataSeries[B].type || "candlestick" === this.parent.dataSeries[B].type || "ohlc" === this.parent.dataSeries[B].type || "boxAndWhisker" === this.parent.dataSeries[B].type) {
                        ...
                        "waterfall" === this.parent.dataSeries[B].type ? (w = 1 === q.lineWidth % 2 ? (this.parent.convertValueToPixel(y.dataSeries.dataPointEOs[y.index].cumulativeSum) << 0) + 0.5 : this.parent.convertValueToPixel(y.dataSeries.dataPointEOs[y.index].cumulativeSum) << 0,
                        k.text = this.labelFormatter ? this.labelFormatter({
                            chart: this.chart,
                            axis: this.parent.options,
                            crosshair: this.options,
                            value: y.dataSeries.dataPointEOs[y.index].cumulativeSum
                        }) : r(this.options.label) ? ha(r(c) ? y.dataSeries.dataPointEOs[y.index].cumulativeSum : c, this.valueFormatString, this.chart._cultureInfo) : this.label,
                        this.value = y.dataSeries.dataPointEOs[y.index].cumulativeSum) : (w = 1 === q.lineWidth % 2 ? (r(a) ? d : this.parent.convertValueToPixel(y.dataPoint.y) << 0) + 0.5 : r(a) ? d : this.parent.convertValueToPixel(y.dataPoint.y) << 0,
                        k.text = this.labelFormatter ? this.labelFormatter({
                            chart: this.chart,
                            axis: this.parent.options,
                            crosshair: this.options,
                    ...
                    if ("left" === this.parent._position || "right" === this.parent._position) {
                        ...
                        if ("bottom" === this.parent._position || "top" === this.parent._position)
                            k.text = this.labelFormatter ? this.labelFormatter({
                                ...
                                crosshair: this.options,
                                value: r(c) ? this.parent.convertPixelToValue(a) : c
                            }) : r(this.options.label) ? ha(r(c) ? this.parent.convertPixelToValue(a) : c, this.valueFormatString, this.chart._cultureInfo) : this.label,
                            k.x = b - k.measureText().width / 2,
                            k.x + k.width > this.chart.bounds.x2 && (k.x = this.chart.bounds.x2 - k.width),
                            k.x < this.chart.bounds.x1 && (k.x = this.chart.bounds.x1),
                            "bottom" === this.parent._position ? k.y = this.parent.lineCoordinates.y2 + k.fontSize / 2 + 2 : "top" === this.parent._position && (k.y = this.parent.lineCoordinates.y1 - k.height + k.fontSize / 2 + 2)
        ...
        Y.prototype.highlightObjects = function(a) {
            ...
            for (c = 0; c < a.length; c++) {
                ...
                if ((e = this.chart._eventManager.objectMap[e.dataSeries.dataPointIds[e.index]]) && e.objectType && "dataPoint" === e.objectType) {
                    ...
                    f.borderColor = f.borderColor || "#FFFFFF",
                    f.borderThickness = f.borderThickness || Math.ceil(0.1 * f.size),
                    aa.drawMarkers([f]))) : "bubble" === b.type ? (f = b.getMarkerProperties(h, e.x1, e.y1, this.chart.overlaidCanvasCtx),
                    f.size = e.size,
                    f.color = "white",
                    f.borderColor = "white",
                    d.globalAlpha = 0.3,
                    aa.drawMarkers([f]),
                    d.globalAlpha = 1) : "column" === b.type || "stackedColumn" === b.type || "stackedColumn100" === b.type || "bar" === b.type || "rangeBar" === b.type || "stackedBar" === b.type || "stackedBar100" === b.type || "rangeColumn" === b.type || "waterfall" === b.type ? da(d, e.x1, e.y1, e.x2, e.y2, "white", 0, null, !1, !1, !1, !1, 0.3) : "pie" === b.type || "doughnut" === b.type ? ra(d, e.center, e.radius, "white", b.type, e.startAngle, e.endAngle, 0.3, e.percentInnerRadius) : "funnel" === b.type || "pyramid" === b.type ? ta(d, e.funnelSection, 0.3, "white") : "candlestick" === b.type ? (d.globalAlpha = 1,
                    ...
                    d.stroke()),
                    d.restore(),
                    d.globalAlpha = 1) : "error" === b.type && B(d, e.x1, e.y1, e.x2, e.y2, "white", e.whiskerProperties, e.stemProperties, e.isXYSwapped, 0.3))
                }
            }
            d.restore();
            d.globalAlpha = 1;
        ...
        Y.prototype.getToolTipInnerHTML = function(a) {
            ...
            if (this.isToolTipDefinedInData && (this.content && "function" === typeof this.content || this.contentFormatter))
                ...
                for (var n = null, r = "", h = 0; h < a.length; h++) {
                    ...
                    null === b.toolTipContent || "undefined" === typeof b.toolTipContent && null === c.options.toolTipContent || ("line" === c.type || "stepLine" === c.type || "spline" === c.type || "area" === c.type || "stepArea" === c.type || "splineArea" === c.type || "column" === c.type || "bar" === c.type || "scatter" === c.type || "stackedColumn" === c.type || "stackedColumn100" === c.type || "stackedBar" === c.type || "stackedBar100" === c.type || "stackedArea" === c.type || "stackedArea100" === c.type || "waterfall" === c.type ? (this.chart.axisX && 1 < this.chart.axisX.length && (f += n != c.axisXIndex ? c.axisX.title ? c.axisX.title + "<br/>" : "X:{axisXIndex}<br/>" : ""),
                    ...
                    n = c.axisXIndex) : "bubble" === c.type ? (this.chart.axisX && 1 < this.chart.axisX.length && (f += n != c.axisXIndex ? c.axisX.title ? c.axisX.title + "<br/>" : "X:{axisXIndex}<br/>" : ""),
        ...
        Y.prototype.showAtX = function(a, d) {
            ...
            if (this.shared)
                for (var h = 0; h < this.chart.data.length; h++)
                    c = this.chart.data[h],
                    (b = c.getDataPointAtX(a, !1)) && (b.dataPoint && !r(b.dataPoint.y) && c.visible) && (b.dataSeries = c,
                    f.push(b));
            else
                c = this.chart.data[d],
                (b = c.getDataPointAtX(a, !1)) && (b.dataPoint && !r(b.dataPoint.y) && c.visible) && (b.dataSeries = c,
          ...
          , aa = {
            drawMarker: function(a, d, c, b, e, f, h, n) {
                if (c) {
                    ...
                    f && c.fill(),
                    n && (h ? c.stroke() : (r = c.globalAlpha,
                    c.globalAlpha = 0.15,
                    c.strokeStyle = "black",
                    c.stroke(),
                    c.globalAlpha = r))) : "square" === b ? (c.beginPath(),
                    ...
                    c.strokeStyle = "black",
                    c.stroke(),
                    c.globalAlpha = r))) : "triangle" === b ? (c.beginPath(),
